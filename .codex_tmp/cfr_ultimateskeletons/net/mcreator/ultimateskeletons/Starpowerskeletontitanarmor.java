...
public class Starpowerskeletontitanarmor
extends GeoRenderLayer<StarskeletonpowertitanEntity> {
    public Starpowerskeletontitanarmor(GeoRenderer<StarskeletonpowertitanEntity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, StarskeletonpowertitanEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
    ...
    protected ResourceLocation getTextureLocation() {
        return new ResourceLocation("ultimateskeletons:textures/item/powerstar.png");
    }
}
