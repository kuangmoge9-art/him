...
public class Starlighttitanuniverselayer
extends GeoRenderLayer<StarlightDeathEntity> {
    final ResourceLocation LAYER0 = new ResourceLocation("ultimateskeletons", "textures/entities/galaxyer.png");
    final ResourceLocation LAYERR1 = new ResourceLocation("ultimateskeletons", "textures/entities/alpha.png");
    ...
    public Starlighttitanuniverselayer(GeoRenderer<StarlightDeathEntity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, StarlightDeathEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
