...
extends Item {
    ...
    public void m_5929_(Level world, LivingEntity entity, ItemStack itemstack, int count) {
        if (!world.m_5776_() && entity instanceof ServerPlayer) {
            ...
            if (player.m_150110_().f_35937_ || stack != ItemStack.f_41583_) {
                GrowtherEntity projectile = GrowtherEntity.shoot(world, entity, world.m_213780_());
    ...
    private ItemStack findAmmo(Player player) {
        ItemStack stack = ProjectileWeaponItem.m_43010_((LivingEntity)player, e -> e.m_41720_() == GrowtherEntity.PROJECTILE_ITEM.m_41720_());
        if (stack == ItemStack.f_41583_) {
            for (int i = 0; i < player.m_150109_().f_35974_.size(); ++i) {
                ItemStack teststack = (ItemStack)player.m_150109_().f_35974_.get(i);
                if (teststack == null || teststack.m_41720_() != GrowtherEntity.PROJECTILE_ITEM.m_41720_()) continue;
                stack = teststack;
                break;
            }
        }
