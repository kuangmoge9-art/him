...
public class Energyskeletontitanarmor
extends GeoRenderLayer<EnergyskeletontitanEntity> {
    public Energyskeletontitanarmor(GeoRenderer<EnergyskeletontitanEntity> entityRenderer) {
    ...
    public void render(PoseStack poseStack, EnergyskeletontitanEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ...
        if (animatable.energy) {
            ...
            this.getRenderer().reRender(this.getDefaultBakedModel((GeoAnimatable)animatable), poseStack, bufferSource, (GeoAnimatable)animatable, glowRenderType, bufferSource.m_6299_(glowRenderType), partialTick, packedLight, OverlayTexture.f_118083_, red, colorIntensity, red, 0.6f);
        }
    }
