...
public class LightningballlightningProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        if (world instanceof ServerLevel) {
            ServerLevel _level = (ServerLevel)world;
            Entity entityToSpawn = ((EntityType)UltimateskeletonsModEntities.PURPLELIGHTNING.get()).m_262496_(_level, BlockPos.m_274561_((double)x, (double)y, (double)z), MobSpawnType.MOB_SUMMONED);
        ...
        for (Entity entityiterator : _entfound) {
            if (!(entityiterator instanceof EndermantitanEntity)) {
                float f;
