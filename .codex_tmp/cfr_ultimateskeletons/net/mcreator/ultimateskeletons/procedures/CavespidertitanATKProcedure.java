...
public class CavespidertitanATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        int n5;
        int n6;
        CavespidertitanEntity _datEntI;
        int n7;
        Mob _mobEnt;
        Mob _mobEnt2;
        CavespidertitanEntity _datEntI2;
        Object _mobEnt3;
        Mob _mobEnt4;
        CavespidertitanEntity _datEntI3;
        CavespidertitanEntity _datEntI4;
        block699: {
            ...
            block700: {
                block701: {
                    ...
                    block697: {
                        block698: {
                            ...
                            int n16;
                            ServerLevel _level;
                            CavespidertitanEntity _datEntI5;
                            block696: {
                                int n17;
                                int n18;
                                int n19;
                                ...
                                if (entity instanceof CavespidertitanEntity) {
                                    int n21;
                                    CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                                    SynchedEntityData synchedEntityData = _datEntSetI.m_20088_();
                                    if (entity instanceof CavespidertitanEntity) {
                                        _datEntI4 = (CavespidertitanEntity)entity;
                                        n21 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                                    } else {
                                        n21 = 0;
                                    }
                                    synchedEntityData.m_135381_(CavespidertitanEntity.DATA_spawnTick, (Object)(n21 + 1));
                                }
                                ...
                                if (f3 <= 0.0f) {
                                    ...
                                    if (entity instanceof CavespidertitanEntity) {
                                        _datEntI4 = (CavespidertitanEntity)entity;
                                        n22 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
                                    } else {
                                        n22 = 0;
                                    }
                                    if (n22 == 0) {
                                        ...
                                        if (entity instanceof CavespidertitanEntity) {
                                            ...
                                            SynchedEntityData synchedEntityData = _datEntSetI.m_20088_();
                                            if (entity instanceof CavespidertitanEntity) {
                                                CavespidertitanEntity _datEntI6 = (CavespidertitanEntity)entity;
                                                n28 = (Integer)_datEntI6.m_20088_().m_135370_(CavespidertitanEntity.DATA_deathTick);
                                            } else {
                                                n28 = 0;
                                            }
                                            synchedEntityData.m_135381_(CavespidertitanEntity.DATA_deathTick, (Object)(n28 + 1));
                                        }
                                        if (entity instanceof CavespidertitanEntity) {
                                            _datEntI5 = (CavespidertitanEntity)entity;
                                            n27 = (Integer)_datEntI5.m_20088_().m_135370_(CavespidertitanEntity.DATA_deathTick);
                                        } else {
                                            n27 = 0;
                                        }
                                        ...
                                        if (entity instanceof CavespidertitanEntity) {
                                            _datEntI5 = (CavespidertitanEntity)entity;
                                            n26 = (Integer)_datEntI5.m_20088_().m_135370_(CavespidertitanEntity.DATA_deathTick);
                                        } else {
                                            n26 = 0;
                                        }
                                        if (n26 < 3) {
                                        ...
                                        if (entity instanceof CavespidertitanEntity) {
                                            _datEntI5 = (CavespidertitanEntity)entity;
                                            n25 = (Integer)_datEntI5.m_20088_().m_135370_(CavespidertitanEntity.DATA_deathTick);
                                        } else {
                                            n25 = 0;
                                        }
                                        if (n25 < 10 && entity instanceof CavespidertitanEntity) {
                                            ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.death");
                                        }
                                        if (entity instanceof CavespidertitanEntity) {
                                            _datEntI5 = (CavespidertitanEntity)entity;
                                            n24 = (Integer)_datEntI5.m_20088_().m_135370_(CavespidertitanEntity.DATA_deathTick);
                                        } else {
                                            n24 = 0;
                                        }
                                        if (n24 == 700) {
                                            if (world instanceof ServerLevel) {
                                                ...
                                                _level3.m_7654_().m_129892_().m_230957_(new CommandSourceStack(CommandSource.f_80164_, new Vec3(x, y + 1.0, z), Vec2.f_82462_, _level3, 4, "", (Component)Component.m_237113_((String)""), _level3.m_7654_(), null).m_81324_(), "summon ultimateskeletons:titanspirit ~ ~1 ~ {CustomName:'\"cavespidertitan\"'}");
                                            }
                                        ...
                                        if (entity instanceof CavespidertitanEntity) {
                                            _datEntI5 = (CavespidertitanEntity)entity;
                                            n23 = (Integer)_datEntI5.m_20088_().m_135370_(CavespidertitanEntity.DATA_deathTick);
                                        } else {
                                            n23 = 0;
                                        }
                                ...
                                if (entity instanceof CavespidertitanEntity) {
                                    _datEntI3 = (CavespidertitanEntity)entity;
                                    n20 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                                } else {
                                    n20 = 0;
                                }
                                ...
                                ((CavespidertitanEntity)entity).setHEALTS(12000.0);
                                if (entity instanceof Mob) {
                                    _entity = (Mob)entity;
                                    _entity.m_6710_(null);
                                }
                                if (entity instanceof CavespidertitanEntity) {
                                    _datEntI4 = (CavespidertitanEntity)entity;
                                    n19 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                                } else {
                                    n19 = 0;
                                }
                                ...
                                if (entity instanceof CavespidertitanEntity) {
                                    _datEntI4 = (CavespidertitanEntity)entity;
                                    n18 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                                } else {
                                    n18 = 0;
                                }
                                if (n18 <= 10 && entity instanceof CavespidertitanEntity) {
                                    ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.titanizion");
                                }
                                if (entity instanceof CavespidertitanEntity) {
                                    _datEntI4 = (CavespidertitanEntity)entity;
                                    n17 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                                } else {
                                    n17 = 0;
                                }
                                if (n17 == 719) {
                                    ...
                                    if (!world.m_5776_() && world.m_7654_() != null) {
                                        world.m_7654_().m_6846_().m_240416_((Component)Component.m_237113_((String)"Cavespidertitan has been created!!!"), false);
                                    }
                                }
                            ...
                            if (entity instanceof CavespidertitanEntity) {
                                _datEntI3 = (CavespidertitanEntity)entity;
                                n16 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                            } else {
                                n16 = 0;
                            }
                            if (n16 >= 220) break block697;
                            entity.m_6593_((Component)Component.m_237113_((String)"Cavespidertitan"));
                            if (entity instanceof LivingEntity) {
                                ((LivingEntity)entity).f_20919_ = 0;
                            }
                            ((CavespidertitanEntity)entity).setHEALTS(12000.0);
                            ...
                            if (entity instanceof CavespidertitanEntity) {
                                _datEntI4 = (CavespidertitanEntity)entity;
                                n15 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                            } else {
                                n15 = 0;
                            }
                            if (n15 == 1) {
                            ...
                            if (entity instanceof CavespidertitanEntity) {
                                _datEntI4 = (CavespidertitanEntity)entity;
                                n14 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                            } else {
                                n14 = 0;
                            }
                            if (n14 <= 10 && entity instanceof CavespidertitanEntity) {
                                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.spawn");
                            }
                            if (entity instanceof CavespidertitanEntity) {
                                _datEntI4 = (CavespidertitanEntity)entity;
                                n13 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                            } else {
                                n13 = 0;
                            }
                            if (n13 == 219 && !world.m_5776_() && world.m_7654_() != null) {
                                world.m_7654_().m_6846_().m_240416_((Component)Component.m_237113_((String)"Cavespidertitan awake!!!"), false);
                            }
                            if (entity instanceof CavespidertitanEntity) {
                                _datEntI4 = (CavespidertitanEntity)entity;
                                n12 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                            } else {
                                n12 = 0;
                            }
                            ...
                            if (entity instanceof CavespidertitanEntity) {
                                _datEntI5 = (CavespidertitanEntity)entity;
                                n11 = (Integer)_datEntI5.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                            } else {
                                n11 = 0;
                            }
                        ...
                        while (object.hasNext()) {
                            ...
                            if (entityiterator instanceof CavespidertitanEntity) continue;
                    ...
                    if (!world.m_5776_()) {
                        ...
                        if (entity instanceof CavespidertitanEntity) {
                            _datEntI3 = (CavespidertitanEntity)entity;
                            n29 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
                        } else {
                            n29 = 0;
                        }
                        if (n29 != 0) {
                            ...
                            if (f4 <= 0.0f) {
                                for (int index2 = 0; index2 < 16; ++index2) {
                                    if (!(entity instanceof CavespidertitanEntity)) continue;
                                    ((CavespidertitanEntity)entity).setAnimation("empty");
                                }
                            }
                        }
                    }
                    ...
                    if (f2 > 0.0f && entity instanceof CavespidertitanEntity) {
                        CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                        _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_deathTick, (Object)0);
                    }
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI3 = (CavespidertitanEntity)entity;
                        n10 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_spawnTick);
                    } else {
                        n10 = 0;
                    }
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI4 = (CavespidertitanEntity)entity;
                        n9 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
                    } else {
                        n9 = 0;
                    }
                    if (n9 == 0) {
                        int n30;
                        if (entity instanceof CavespidertitanEntity) {
                            CavespidertitanEntity _datEntI7 = (CavespidertitanEntity)entity;
                            n30 = (Integer)_datEntI7.m_20088_().m_135370_(CavespidertitanEntity.DATA_flyID);
                        } else {
                            n30 = 0;
                        }
                        if (n30 != 0) {
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI4 = (CavespidertitanEntity)entity;
                        n8 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
                    } else {
                        n8 = 0;
                    }
                    if (n8 != 0 && entity instanceof CavespidertitanEntity) {
                        int n31;
                        CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                        SynchedEntityData synchedEntityData = _datEntSetI.m_20088_();
                        if (entity instanceof CavespidertitanEntity) {
                            CavespidertitanEntity _datEntI8 = (CavespidertitanEntity)entity;
                            n31 = (Integer)_datEntI8.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
                        } else {
                            n31 = 0;
                        }
                        synchedEntityData.m_135381_(CavespidertitanEntity.DATA_animationTick, (Object)(n31 + 1));
                    }
                    if (entity instanceof Mob) {
                        _mobEnt4 = (Mob)entity;
                ...
                if (entity instanceof CavespidertitanEntity) {
                    CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                    _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_flyID, (Object)0);
                }
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
            ...
            if (livingEntity != null) {
                ...
                if (f > 0.0f) {
                    int n32;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI2 = (CavespidertitanEntity)entity;
                        n32 = (Integer)_datEntI2.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
                    } else {
                        n32 = 0;
                    }
                    if (n32 == 0) {
                        ...
                        if (f6 > 60.0f) {
                            ...
                            if (entity instanceof CavespidertitanEntity) {
                                CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                                _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_flyID, (Object)1);
                            }
                        } else {
                        ...
                        if (f5 < 512.0f) {
                                ...
                                if (((Boolean)SkeletonsConfiguration.ALLOW.get()).booleanValue()) {
                                    ...
                                    if (livingEntity42.m_20206_() > 6.0f) {
                                        if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)8) == 8) {
                                            if (entity instanceof CavespidertitanEntity) {
                                                _datEntSetI = (CavespidertitanEntity)entity;
                                                _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)3, (int)4));
                                            }
                                        } else if (entity instanceof CavespidertitanEntity) {
                                            _datEntSetI = (CavespidertitanEntity)entity;
                                            _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)5);
                                        }
                                        ...
                                        _datEntSetI = (CavespidertitanEntity)entity;
                                        _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)2));
                                    }
                                } else {
                                    ...
                                    if (livingEntity43.m_20206_() > 6.0f) {
                                        if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)8) == 8) {
                                            if (entity instanceof CavespidertitanEntity) {
                                                _datEntSetI = (CavespidertitanEntity)entity;
                                                _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)4);
                                            }
                                        } else if (entity instanceof CavespidertitanEntity) {
                                            _datEntSetI = (CavespidertitanEntity)entity;
                                            _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)5);
                            ...
                            if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)10) == 5) {
                                int n33;
                                if (entity instanceof CavespidertitanEntity) {
                                    CavespidertitanEntity _datEntI9 = (CavespidertitanEntity)entity;
                                    n33 = (Integer)_datEntI9.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
                                } else {
                                    n33 = 0;
                                }
                                if (n33 == 0) {
                                    ...
                                    if (f18 > 60.0f) {
                                        if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)10) == 5) {
                                            ...
                                            if (livingEntity46.m_20206_() > 6.0f) {
                                                if (entity instanceof CavespidertitanEntity) {
                                                    _datEntSetI = (CavespidertitanEntity)entity;
                                                    _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)6, (int)7));
                                                }
                                            } else if (entity instanceof CavespidertitanEntity) {
                                                _datEntSetI = (CavespidertitanEntity)entity;
                                                _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)6, (int)7));
                                        ...
                                        if (f19 > 36.0f) {
                                            ...
                                            if (livingEntity49.m_20206_() > 6.0f) {
                                                if (entity instanceof CavespidertitanEntity) {
                                                    _datEntSetI = (CavespidertitanEntity)entity;
                                                    _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)3, (int)5));
                                                }
                                            } else if (entity instanceof CavespidertitanEntity) {
                                                _datEntSetI = (CavespidertitanEntity)entity;
                                                _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)3, (int)4));
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n7 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n7 = 0;
        }
        if (n7 == 1) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.strike");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n35 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n35 = 0;
            }
            if (n35 == 45) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    float f24;
                    LivingEntity _livEnt;
                    if (entityiterator instanceof CavespidertitanEntity || !(entityiterator instanceof LivingEntity)) continue;
                    ...
                    float f25 = f24 / 20.0f + 1500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n40 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n40 = 0;
                    }
                    ...
                    float f26 = f23 / 20.0f + 1500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n39 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n39 = 0;
                    }
                    ...
                    float f27 = f22 / 20.0f + 1500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n38 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n38 = 0;
                    }
                    ...
                    float f28 = f21 / 5.0f + 15000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n37 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n37 = 0;
                    }
                    ...
                    float f29 = f20 / 5.0f + 15000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n36 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n36 = 0;
                    }
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n34 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n34 = 0;
            }
            if (n34 >= 65) {
                if (entity instanceof CavespidertitanEntity) {
                    CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                    _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationID, (Object)0);
                }
                if (entity instanceof CavespidertitanEntity) {
                    CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                    _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_animationTick, (Object)0);
                }
                if (entity instanceof CavespidertitanEntity) {
                    ((CavespidertitanEntity)entity).setAnimation("empty");
                }
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n6 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n6 = 0;
        }
        if (n6 == 2) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.swing");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n42 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n42 = 0;
            }
            if (n42 == 25) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    float f35 = f34 / 20.0f + 750.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n47 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n47 = 0;
                    }
                    ...
                    float f36 = f33 / 20.0f + 750.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n46 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n46 = 0;
                    }
                    ...
                    float f37 = f32 / 20.0f + 750.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n45 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n45 = 0;
                    }
                    ...
                    float f38 = f31 / 5.0f + 7500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n44 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n44 = 0;
                    }
                    ...
                    float f39 = f30 / 5.0f + 7500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n43 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n43 = 0;
                    }
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n41 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n41 = 0;
            }
            if (n41 >= 50) {
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n5 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n5 = 0;
        }
        if (n5 == 3) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.spraying poison");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n49 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n49 = 0;
            }
            if (n49 >= 65) {
                int n50;
                if (entity instanceof CavespidertitanEntity) {
                    CavespidertitanEntity _datEntI10 = (CavespidertitanEntity)entity;
                    n50 = (Integer)_datEntI10.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
                } else {
                    n50 = 0;
                }
                if (n50 <= 105) {
                    ...
                    if (f40 > 1.0f) {
                        for (int index3 = 0; index3 < 12; ++index3) {
                            ...
                            _entityToSpawn.m_6034_(x + entity.m_20154_().f_82479_ * 8.0, y + 9.0, z + entity.m_20154_().f_82481_ * 8.0);
                            if (entity instanceof Mob) {
                                _mobEnt = (Mob)entity;
                            ...
                            double d21 = livingEntity68.m_20186_() - 9.0 - entity.m_20186_();
                            if (entity instanceof Mob) {
                                _mobEnt = (Mob)entity;
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n48 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n48 = 0;
            }
            if (n48 >= 130) {
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n4 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n4 = 0;
        }
        if (n4 == 4) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.press");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n52 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n52 = 0;
            }
            if (n52 == 70) {
                ...
                Vec3 _center = new Vec3(x + entity.m_20154_().f_82479_ * 28.0, y, z + entity.m_20154_().f_82481_ * 28.0);
                List<Entity> _entfound = world.m_6443_(Entity.class, new AABB(_center, _center).m_82400_(60.0), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.m_20238_(_center))).toList();
                for (Entity entityiterator : _entfound) {
                    int n53;
                    float f41;
                    ...
                    float f48 = f43 / 20.0f + 3750.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n55 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n55 = 0;
                    }
                    ...
                    float f49 = f42 / 5.0f + 37500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n54 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n54 = 0;
                    }
                    ...
                    float f50 = f41 / 5.0f + 37500.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n53 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n53 = 0;
                    }
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n51 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n51 = 0;
            }
            if (n51 >= 90) {
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n3 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n3 = 0;
        }
        if (n3 == 5) {
            ...
            if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)4) == 1) {
                if (entity instanceof CavespidertitanEntity) {
                    ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.attack1");
                }
            } else if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)4) == 2) {
                if (entity instanceof CavespidertitanEntity) {
                    ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.attack2");
                }
            } else if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)4) == 3) {
                if (entity instanceof CavespidertitanEntity) {
                    ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.attack3");
                }
            } else if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.attack4");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n59 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n59 = 0;
            }
            if (n59 == 16) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    float f56 = f55 / 20.0f + 3000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n64 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n64 = 0;
                    }
                    ...
                    float f57 = f54 / 20.0f + 3000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n63 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n63 = 0;
                    }
                    ...
                    float f58 = f53 / 20.0f + 3000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n62 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n62 = 0;
                    }
                    ...
                    float f59 = f52 / 5.0f + 30000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n61 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n61 = 0;
                    }
                    ...
                    float f60 = f51 / 5.0f + 30000.0f;
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n60 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n60 = 0;
                    }
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n58 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n58 = 0;
            }
            if (n58 >= 30) {
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n2 = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n2 = 0;
        }
        if (n2 == 6) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.lightningthunder");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n66 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n66 = 0;
            }
            if (n66 == 45) {
                ...
                Vec3 _center = new Vec3(x, y, z);
                List<Entity> _entfound = world.m_6443_(Entity.class, new AABB(_center, _center).m_82400_(180.0), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.m_20238_(_center))).toList();
                for (Entity entityiterator : _entfound) {
                    int n67;
                    float f62;
                    int n68;
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n71 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n71 = 0;
                    }
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n70 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n70 = 0;
                    }
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n69 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n69 = 0;
                    }
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n68 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n68 = 0;
                    }
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        _datEntI = (CavespidertitanEntity)entity;
                        n67 = (Integer)_datEntI.m_20088_().m_135370_(CavespidertitanEntity.DATA_killCount);
                    } else {
                        n67 = 0;
                    }
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n65 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n65 = 0;
            }
            if (n65 >= 80) {
        ...
        if (entity instanceof CavespidertitanEntity) {
            _datEntI3 = (CavespidertitanEntity)entity;
            n = (Integer)_datEntI3.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationID);
        } else {
            n = 0;
        }
        if (n == 7) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof CavespidertitanEntity) {
                ((CavespidertitanEntity)entity).setAnimation("animation.spider.titan.spider web");
            }
            if (entity instanceof Mob) {
                _mobEnt4 = (Mob)entity;
                livingEntity = _mobEnt4.m_5448_();
            ...
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n73 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n73 = 0;
            }
            if (n73 >= 45) {
                int n74;
                if (entity instanceof CavespidertitanEntity) {
                    CavespidertitanEntity _datEntI11 = (CavespidertitanEntity)entity;
                    n74 = (Integer)_datEntI11.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
                } else {
                    n74 = 0;
                }
                if (n74 <= 185) {
                    ...
                    if (entity instanceof CavespidertitanEntity) {
                        ...
                        if (entity instanceof CavespidertitanEntity) {
                            _datEntI2 = (CavespidertitanEntity)entity;
                            n77 = (Integer)_datEntI2.m_20088_().m_135370_(CavespidertitanEntity.DATA_webTick);
                        } else {
                            n77 = 0;
                        }
                        synchedEntityData.m_135381_(CavespidertitanEntity.DATA_webTick, (Object)(n77 + 1));
                    }
                    if (entity instanceof CavespidertitanEntity) {
                        CavespidertitanEntity _datEntI12 = (CavespidertitanEntity)entity;
                        n76 = (Integer)_datEntI12.m_20088_().m_135370_(CavespidertitanEntity.DATA_webTick);
                    } else {
                        n76 = 0;
                    }
                    if (n76 == 5 && world instanceof ServerLevel) {
                        ...
                        _entityToSpawn.m_6034_(x, y + 5.0, z);
                        _entityToSpawn.m_6686_(entity.m_20154_().f_82479_, 0.0, entity.m_20154_().f_82481_, 4.0f, 4.0f);
                        projectileLevel.m_7967_((Entity)_entityToSpawn);
                    }
                    if (entity instanceof CavespidertitanEntity) {
                        CavespidertitanEntity _datEntI13 = (CavespidertitanEntity)entity;
                        n75 = (Integer)_datEntI13.m_20088_().m_135370_(CavespidertitanEntity.DATA_webTick);
                    } else {
                        n75 = 0;
                    }
                    if (n75 >= 10 && entity instanceof CavespidertitanEntity) {
                        CavespidertitanEntity _datEntSetI = (CavespidertitanEntity)entity;
                        _datEntSetI.m_20088_().m_135381_(CavespidertitanEntity.DATA_webTick, (Object)0);
                    }
                }
            }
            if (entity instanceof CavespidertitanEntity) {
                _datEntI4 = (CavespidertitanEntity)entity;
                n72 = (Integer)_datEntI4.m_20088_().m_135370_(CavespidertitanEntity.DATA_animationTick);
            } else {
                n72 = 0;
            }
            if (n72 >= 215) {
