...
public class PosionATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        Vec3 _center = new Vec3(x, y, z);
        List<Entity> _entfound = world.m_6443_(Entity.class, new AABB(_center, _center).m_82400_(4.0), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.m_20238_(_center))).toList();
        for (Entity entityiterator : _entfound) {
            float f;
            if (entityiterator instanceof SpidertitanEntity || entityiterator instanceof CavespidertitanEntity || !(entityiterator instanceof LivingEntity)) continue;
            ...
            entityiterator.m_6469_(damageSource, f / 1000.0f + 25.0f);
