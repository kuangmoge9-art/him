...
public class ChaoslightningballATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        ...
        for (Entity entityiterator : _entfound) {
            float f;
            if (entityiterator instanceof ChaoscolossusEntity) continue;
            ...
            entityiterator.m_6469_(damageSource, f / 5.0f + 200000.0f);
            ...
            if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)5) == 5 && world instanceof ServerLevel) {
                ...
                Entity entityToSpawn = ((EntityType)UltimateskeletonsModEntities.REDLIGHTNING.get()).m_262496_(_level, BlockPos.m_274561_((double)entityiterator.m_20185_(), (double)entityiterator.m_20186_(), (double)entityiterator.m_20189_()), MobSpawnType.MOB_SUMMONED);
