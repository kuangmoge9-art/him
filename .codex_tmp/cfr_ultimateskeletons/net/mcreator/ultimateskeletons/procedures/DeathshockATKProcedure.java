...
public class DeathshockATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        int n;
        int n2;
        int n3;
        DeathshockEntity _datEntI;
        DeathshockEntity _datEntI2;
        if (entity == null) {
            return;
        }
        ...
        if (entity instanceof DeathshockEntity) {
            int n4;
            DeathshockEntity _datEntSetI = (DeathshockEntity)entity;
            SynchedEntityData synchedEntityData = _datEntSetI.m_20088_();
            if (entity instanceof DeathshockEntity) {
                _datEntI2 = (DeathshockEntity)entity;
                n4 = (Integer)_datEntI2.m_20088_().m_135370_(DeathshockEntity.DATA_gamaspawnTick);
            } else {
                n4 = 0;
            }
            synchedEntityData.m_135381_(DeathshockEntity.DATA_gamaspawnTick, (Object)(n4 + 1));
        }
        if (entity instanceof DeathshockEntity) {
            _datEntI = (DeathshockEntity)entity;
            n3 = (Integer)_datEntI.m_20088_().m_135370_(DeathshockEntity.DATA_gamaspawnTick);
        } else {
            n3 = 0;
        }
        if (n3 >= 45) {
            if (entity instanceof DeathshockEntity) {
                DeathshockEntity _datEntSetI = (DeathshockEntity)entity;
                _datEntSetI.m_20088_().m_135381_(DeathshockEntity.DATA_gamaspawnTick, (Object)0);
            }
        ...
        if (entity instanceof DeathshockEntity) {
            ((DeathshockEntity)entity).setAnimation("animation.shock");
        }
        if (entity instanceof DeathshockEntity) {
            _datEntI = (DeathshockEntity)entity;
            n2 = (Integer)_datEntI.m_20088_().m_135370_(DeathshockEntity.DATA_gamaspawnTick);
        } else {
            n2 = 0;
        }
        ...
        if (entity instanceof DeathshockEntity) {
            _datEntI = (DeathshockEntity)entity;
            n = (Integer)_datEntI.m_20088_().m_135370_(DeathshockEntity.DATA_gamaspawnTick);
        } else {
            n = 0;
        }
        if (n >= 7) {
            ...
            if (entity instanceof DeathshockEntity) {
                _datEntI2 = (DeathshockEntity)entity;
                n5 = (Integer)_datEntI2.m_20088_().m_135370_(DeathshockEntity.DATA_gamaspawnTick);
            } else {
                n5 = 0;
            }
            if (n5 <= 45) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    if (entityiterator instanceof DeathskullEntity || entityiterator instanceof UltimatedeathskullEntity || entityiterator instanceof DeathlaserEntity || entityiterator instanceof ElectricbombEntity || entityiterator instanceof Player) continue;
