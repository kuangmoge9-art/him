...
public class FlashballATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        ...
        for (Entity entityiterator : _entfound) {
            float f;
            if (entityiterator instanceof Ghast || entityiterator instanceof ZombiepigmantitanEntity || entityiterator instanceof ZombifiedPiglin) continue;
            ...
            entityiterator.m_6469_(damageSource, f / 30.0f + 300.0f);
