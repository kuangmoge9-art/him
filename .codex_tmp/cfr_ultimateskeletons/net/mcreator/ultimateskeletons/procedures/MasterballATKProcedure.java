...
public class MasterballATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        ...
        for (Entity entityiterator : _entfound) {
            float f;
            if (entityiterator instanceof ZombietitanEntity || entityiterator instanceof ZombiepigmantitanEntity || entityiterator instanceof ZombifiedPiglin || entityiterator instanceof Zombie) continue;
            ...
            entityiterator.m_6469_(damageSource, f / 40.0f + 40.0f);
