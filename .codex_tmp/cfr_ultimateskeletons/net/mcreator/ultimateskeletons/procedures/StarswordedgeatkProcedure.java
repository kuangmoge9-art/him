...
public class StarswordedgeatkProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        for (Entity entityiterator : _entfound) {
            float f;
            if (entityiterator instanceof HarrowEntity || entityiterator instanceof SwordedgecutEntity || entityiterator instanceof SwordedgeslashEntity || entityiterator instanceof StarskeletonEntity) continue;
