...
public class GiantadminiumATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        Level _level;
        if (world instanceof Level && !(_level = (Level)world).m_5776_()) {
            _level.m_254849_(null, x, y, z, 36.0f, Level.ExplosionInteraction.BLOCK);
        }
        ...
        for (Entity entityiterator : _entfound) {
            if (!(entityiterator instanceof BedrockgolemtitanEntity)) {
                float f;
                ...
                entityiterator.m_6469_(damageSource, f / 10.0f + 1000000.0f);
            }
