...
public class BedrockgolemtitanATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        Object _mobEnt3;
        Mob _mobEnt4;
        BedrockgolemtitanEntity _datEntSetI;
        Level _level;
        BedrockgolemtitanEntity _datEntI;
        block593: {
            int n2;
            int n3;
            ...
            block595: {
                ...
                block594: {
                    ...
                    int n10;
                    BedrockgolemtitanEntity _datEntI2;
                    block590: {
                        int n11;
                        block592: {
                            block591: {
                                ...
                                block587: {
                                    ...
                                    block588: {
                                        block589: {
                                            ...
                                            if (entity instanceof BedrockgolemtitanEntity) {
                                                int n16;
                                                BedrockgolemtitanEntity _datEntSetI2 = (BedrockgolemtitanEntity)entity;
                                                SynchedEntityData synchedEntityData = _datEntSetI2.m_20088_();
                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                    BedrockgolemtitanEntity _datEntI4 = (BedrockgolemtitanEntity)entity;
                                                    n16 = (Integer)_datEntI4.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_spawnTick);
                                                } else {
                                                    n16 = 0;
                                                }
                                                synchedEntityData.m_135381_(BedrockgolemtitanEntity.DATA_spawnTick, (Object)(n16 + 1));
                                            }
                                            if (entity.m_5446_().getString().equals("growing")) {
                                                int n17;
                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                    _datEntI = (BedrockgolemtitanEntity)entity;
                                                    n17 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_spawnTick);
                                                } else {
                                                    n17 = 0;
                                                }
                                                if (n17 <= 720) {
                                                    int n18;
                                                    int n19;
                                                    BedrockgolemtitanEntity _datEntI3;
                                                    ...
                                                    if (entity instanceof BedrockgolemtitanEntity) {
                                                        _datEntI3 = (BedrockgolemtitanEntity)entity;
                                                        n19 = (Integer)_datEntI3.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_spawnTick);
                                                    } else {
                                                        n19 = 0;
                                                    }
                                                    if (n19 <= 10 && entity instanceof BedrockgolemtitanEntity) {
                                                        ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.spawn");
                                                    }
                                                    if (entity instanceof BedrockgolemtitanEntity) {
                                                        _datEntI3 = (BedrockgolemtitanEntity)entity;
                                                        n18 = (Integer)_datEntI3.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_spawnTick);
                                                    } else {
                                                        n18 = 0;
                                                    }
                                                    if (n18 == 720) {
                                                        ...
                                                        if (!world.m_5776_() && world.m_7654_() != null) {
                                                            world.m_7654_().m_6846_().m_240416_((Component)Component.m_237113_((String)"Ultimaadamantiumgolemtitan has been created!!!"), false);
                                                        }
                                                    }
                                            ...
                                            if (!world.m_5776_()) {
                                                ...
                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                    _datEntI = (BedrockgolemtitanEntity)entity;
                                                    n20 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                                                } else {
                                                    n20 = 0;
                                                }
                                                if (n20 != 0) {
                                                    ...
                                                    if (f6 <= 0.0f) {
                                                        for (int index0 = 0; index0 < 16; ++index0) {
                                                            if (!(entity instanceof BedrockgolemtitanEntity)) continue;
                                                            ((BedrockgolemtitanEntity)entity).setAnimation("empty");
                                                        }
                                                    }
                                                }
                                            }
                                            ...
                                            if (f5 > 0.0f) {
                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                    BedrockgolemtitanEntity _datEntSetI3 = (BedrockgolemtitanEntity)entity;
                                                    _datEntSetI3.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_deathTick, (Object)0);
                                                }
                                                for (int index1 = 0; index1 < 12; ++index1) {
                                                    ...
                                                    world.m_7106_((ParticleOptions)ParticleTypes.f_123759_, x + Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0) * (double)entity.m_20205_(), y + Math.random() * (double)entity.m_20206_(), z + Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0) * (double)entity.m_20205_(), Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0), Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0), Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0));
                                                }
                                            }
                                            if (entity instanceof LivingEntity) {
                                            ...
                                            if (f4 <= 0.0f) {
                                                ...
                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                    BedrockgolemtitanEntity _datEntI5 = (BedrockgolemtitanEntity)entity;
                                                    n21 = (Integer)_datEntI5.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                                                } else {
                                                    n21 = 0;
                                                }
                                                if (n21 == 0) {
                                                    ...
                                                    if (entity instanceof BedrockgolemtitanEntity) {
                                                        int n24;
                                                        _datEntSetI = (BedrockgolemtitanEntity)entity;
                                                        SynchedEntityData synchedEntityData = _datEntSetI.m_20088_();
                                                        if (entity instanceof BedrockgolemtitanEntity) {
                                                            BedrockgolemtitanEntity _datEntI3 = (BedrockgolemtitanEntity)entity;
                                                            n24 = (Integer)_datEntI3.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_deathTick);
                                                        } else {
                                                            n24 = 0;
                                                        }
                                                        synchedEntityData.m_135381_(BedrockgolemtitanEntity.DATA_deathTick, (Object)(n24 + 1));
                                                    }
                                                    if (entity instanceof BedrockgolemtitanEntity) {
                                                        BedrockgolemtitanEntity _datEntI22 = (BedrockgolemtitanEntity)entity;
                                                        n23 = (Integer)_datEntI22.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_deathTick);
                                                    } else {
                                                        n23 = 0;
                                                    }
                                                    if (n23 == 1 && world instanceof Level) {
                                                        ...
                                                        if (!_level22.m_5776_()) {
                                                            _level22.m_5594_(null, BlockPos.m_274561_((double)x, (double)y, (double)z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.iron_golem.death")), SoundSource.NEUTRAL, 200.0f, 0.8f);
                                                        } else {
                                                            _level22.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.iron_golem.death")), SoundSource.NEUTRAL, 200.0f, 0.8f, false);
                                                        }
                                                    }
                                                    if (entity instanceof BedrockgolemtitanEntity) {
                                                        ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.death");
                                                    }
                                                    if (entity instanceof BedrockgolemtitanEntity) {
                                                        _datEntI2 = (BedrockgolemtitanEntity)entity;
                                                        n22 = (Integer)_datEntI2.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_deathTick);
                                                    } else {
                                                        n22 = 0;
                                                    }
                                            ...
                                            if (entity instanceof BedrockgolemtitanEntity) {
                                                _datEntI = (BedrockgolemtitanEntity)entity;
                                                n15 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                                            } else {
                                                n15 = 0;
                                            }
                                            if (n15 != 0 && entity instanceof BedrockgolemtitanEntity) {
                                                int n25;
                                                BedrockgolemtitanEntity _datEntSetI4 = (BedrockgolemtitanEntity)entity;
                                                SynchedEntityData synchedEntityData = _datEntSetI4.m_20088_();
                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                    _datEntI2 = (BedrockgolemtitanEntity)entity;
                                                    n25 = (Integer)_datEntI2.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                                                } else {
                                                    n25 = 0;
                                                }
                                                synchedEntityData.m_135381_(BedrockgolemtitanEntity.DATA_animationTick, (Object)(n25 + 1));
                                            }
                                            if (entity instanceof Mob) {
                                            ...
                                            if (livingEntity6 == null) break block588;
                                            if (entity instanceof Mob) {
                                            ...
                                            if (livingEntity4.m_6084_()) break block588;
                                        }
                                        if (entity instanceof Mob) {
                                    ...
                                    if (livingEntity3 != null) {
                                        ...
                                        if (f7 > 0.0f) {
                                            ...
                                            if (entity instanceof BedrockgolemtitanEntity) {
                                                BedrockgolemtitanEntity _datEntI4 = (BedrockgolemtitanEntity)entity;
                                                n26 = (Integer)_datEntI4.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                                            } else {
                                                n26 = 0;
                                            }
                                            if (n26 == 0) {
                                                ...
                                                if (f8 < 512.0f) {
                                                    BedrockgolemtitanEntity _datEntSetI2;
                                                    float f19;
                                                    ...
                                                    if (f19 <= 60.0f) {
                                                        ...
                                                        if (livingEntity42.m_20206_() > 6.0f) {
                                                            if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)4) == 4) {
                                                                if (entity instanceof BedrockgolemtitanEntity) {
                                                                    _datEntSetI2 = (BedrockgolemtitanEntity)entity;
                                                                    _datEntSetI2.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)5, (int)6));
                                                                }
                                                            } else if (entity instanceof BedrockgolemtitanEntity) {
                                                                _datEntSetI2 = (BedrockgolemtitanEntity)entity;
                                                                _datEntSetI2.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationID, (Object)4);
                                                            }
                                                        } else if (entity instanceof BedrockgolemtitanEntity) {
                                                            BedrockgolemtitanEntity _datEntSetI5 = (BedrockgolemtitanEntity)entity;
                                                            _datEntSetI5.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)3));
                                                        }
                                                    }
                                                    if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)10) == 5) {
                                                        int n27;
                                                        if (entity instanceof BedrockgolemtitanEntity) {
                                                            BedrockgolemtitanEntity _datEntI6 = (BedrockgolemtitanEntity)entity;
                                                            n27 = (Integer)_datEntI6.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                                                        } else {
                                                            n27 = 0;
                                                        }
                                                        if (n27 == 0) {
                                                            ...
                                                            if (f20 > 80.0f) {
                                                                if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)30) == 5 && entity instanceof BedrockgolemtitanEntity) {
                                                                    _datEntSetI2 = (BedrockgolemtitanEntity)entity;
                                                                    _datEntSetI2.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationID, (Object)6);
                                                                }
                                                            } else {
                                                                float f21;
                                                                ...
                                                                if (f21 > 60.0f && entity instanceof BedrockgolemtitanEntity) {
                                                                    BedrockgolemtitanEntity _datEntSetI6 = (BedrockgolemtitanEntity)entity;
                                                                    _datEntSetI6.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)5, (int)7));
                                                                }
                                                            }
                                                        }
                                                    }
                                ...
                                if (entity instanceof BedrockgolemtitanEntity) {
                                    _datEntI = (BedrockgolemtitanEntity)entity;
                                    n14 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                                } else {
                                    n14 = 0;
                                }
                                if (n14 != true) break block590;
                                if (entity instanceof BedrockgolemtitanEntity) {
                                    ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.zt");
                                }
                                if (entity instanceof Mob) {
                                ...
                                if (entity instanceof BedrockgolemtitanEntity) {
                                    BedrockgolemtitanEntity _datEntI7 = (BedrockgolemtitanEntity)entity;
                                    n13 = (Integer)_datEntI7.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                                } else {
                                    n13 = 0;
                                }
                                if (n13 == 56) break block591;
                                if (entity instanceof BedrockgolemtitanEntity) {
                                    _datEntI2 = (BedrockgolemtitanEntity)entity;
                                    n12 = (Integer)_datEntI2.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                                } else {
                                    n12 = 0;
                                }
                                if (n12 != 96) break block592;
                            }
                            if (world instanceof Level) {
                                _level2 = (Level)world;
                                if (!_level2.m_5776_()) {
                            ...
                            for (Entity entityiterator2 : _entfound2) {
                                ...
                                float f27;
                                float f28;
                                if (entityiterator2 instanceof BedrockgolemtitanEntity || !(entityiterator2 instanceof LivingEntity)) continue;
                                ...
                                entityiterator2.m_6469_(damageSource, f28 / 20.0f + 1000000.0f);
                                ...
                                entityiterator2.m_6469_(damageSource2, f27 / 20.0f + 1000000.0f);
                                ...
                                entityiterator2.m_6469_(damageSource3, f26 / 20.0f + 1000000.0f);
                                ...
                                if (entityiterator2 instanceof LivingEntity) {
                                    _livEnt = (LivingEntity)entityiterator2;
                                    f24 = _livEnt.m_21223_();
                                } else {
                                    f24 = -1.0f;
                                }
                                entityiterator2.m_6469_(damageSource4, (f25 + f24) / 5.0f + 1.0E7f);
                                ...
                                if (entityiterator2 instanceof LivingEntity) {
                                    _livEnt = (LivingEntity)entityiterator2;
                                    f22 = _livEnt.m_21223_();
                                } else {
                                    f22 = -1.0f;
                                }
                                entityiterator2.m_6469_(damageSource5, (f23 + f22) / 5.0f + 1.0E7f);
                            }
                        }
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI8 = (BedrockgolemtitanEntity)entity;
                            n11 = (Integer)_datEntI8.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n11 = 0;
                        }
                        if (n11 >= 120) {
                            if (entity instanceof BedrockgolemtitanEntity) {
                                _datEntSetI = (BedrockgolemtitanEntity)entity;
                                _datEntSetI.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationTick, (Object)0);
                            }
                            if (entity instanceof BedrockgolemtitanEntity) {
                                _datEntSetI = (BedrockgolemtitanEntity)entity;
                                _datEntSetI.m_20088_().m_135381_(BedrockgolemtitanEntity.DATA_animationID, (Object)0);
                            }
                            if (entity instanceof BedrockgolemtitanEntity) {
                                ((BedrockgolemtitanEntity)entity).setAnimation("empty");
                            }
                    ...
                    if (entity instanceof BedrockgolemtitanEntity) {
                        _datEntI = (BedrockgolemtitanEntity)entity;
                        n10 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                    } else {
                        n10 = 0;
                    }
                    if (n10 == 2) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.zj");
                        }
                        if (entity instanceof Mob) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI9 = (BedrockgolemtitanEntity)entity;
                            n29 = (Integer)_datEntI9.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n29 = 0;
                        }
                        if (n29 == 36) {
                            ...
                            for (Entity entity2 : _entfound) {
                                ...
                                float f35;
                                float f36;
                                if (entity2 instanceof BedrockgolemtitanEntity || !(entity2 instanceof LivingEntity)) continue;
                                DamageSource damageSource = new DamageSource((Holder)world.m_9598_().m_175515_(Registries.f_268580_).m_246971_(DamageTypes.f_268724_), entity, entity);
                                if (entity2 instanceof LivingEntity) {
                                    LivingEntity _livEnt32 = (LivingEntity)entity2;
                                    f36 = _livEnt32.m_21233_();
                                } else {
                                    f36 = -1.0f;
                                }
                                entity2.m_6469_(damageSource, f36 / 20.0f + 1000000.0f);
                                ...
                                if (entity2 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity2;
                                    f35 = _livEnt3.m_21233_();
                                } else {
                                    f35 = -1.0f;
                                }
                                entity2.m_6469_(damageSource6, f35 / 20.0f + 1000000.0f);
                                ...
                                entity2.m_6469_(damageSource7, f34 / 20.0f + 1000000.0f);
                                ...
                                if (entity2 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity2;
                                    f32 = _livEnt3.m_21223_();
                                } else {
                                    f32 = -1.0f;
                                }
                                entity2.m_6469_(damageSource8, (f33 + f32) / 5.0f + 1.0E7f);
                                ...
                                if (entity2 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity2;
                                    f30 = _livEnt3.m_21223_();
                                } else {
                                    f30 = -1.0f;
                                }
                                entity2.m_6469_(damageSource9, (f31 + f30) / 5.0f + 1.0E7f);
                            }
                        }
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI10 = (BedrockgolemtitanEntity)entity;
                            n28 = (Integer)_datEntI10.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n28 = 0;
                        }
                        if (n28 >= 60) {
                    ...
                    if (entity instanceof BedrockgolemtitanEntity) {
                        _datEntI = (BedrockgolemtitanEntity)entity;
                        n9 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                    } else {
                        n9 = 0;
                    }
                    if (n9 == 3) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.gt");
                        }
                        if (entity instanceof Mob) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI11 = (BedrockgolemtitanEntity)entity;
                            n31 = (Integer)_datEntI11.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n31 = 0;
                        }
                        if (n31 == 48) {
                            ...
                            for (Entity entity3 : _entfound) {
                                ...
                                float f43;
                                float f44;
                                if (entity3 instanceof BedrockgolemtitanEntity || !(entity3 instanceof LivingEntity)) continue;
                                DamageSource damageSource = new DamageSource((Holder)world.m_9598_().m_175515_(Registries.f_268580_).m_246971_(DamageTypes.f_268724_), entity, entity);
                                if (entity3 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity3;
                                    f44 = _livEnt3.m_21233_();
                                } else {
                                    f44 = -1.0f;
                                }
                                entity3.m_6469_(damageSource, f44 / 20.0f + 2100000.0f);
                                ...
                                if (entity3 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity3;
                                    f43 = _livEnt3.m_21233_();
                                } else {
                                    f43 = -1.0f;
                                }
                                entity3.m_6469_(damageSource10, f43 / 20.0f + 2100000.0f);
                                ...
                                entity3.m_6469_(damageSource11, f42 / 20.0f + 2100000.0f);
                                ...
                                if (entity3 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity3;
                                    f40 = _livEnt3.m_21223_();
                                } else {
                                    f40 = -1.0f;
                                }
                                entity3.m_6469_(damageSource12, (f41 + f40) / 5.0f + 2.1E7f);
                                ...
                                if (entity3 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity3;
                                    f38 = _livEnt3.m_21223_();
                                } else {
                                    f38 = -1.0f;
                                }
                                entity3.m_6469_(damageSource13, (f39 + f38) / 5.0f + 2.1E7f);
                            }
                        }
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI12 = (BedrockgolemtitanEntity)entity;
                            n30 = (Integer)_datEntI12.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n30 = 0;
                        }
                        if (n30 >= 80) {
                    ...
                    if (entity instanceof BedrockgolemtitanEntity) {
                        _datEntI = (BedrockgolemtitanEntity)entity;
                        n8 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                    } else {
                        n8 = 0;
                    }
                    if (n8 == 4) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.attack");
                        }
                        if (entity instanceof Mob) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI13 = (BedrockgolemtitanEntity)entity;
                            n33 = (Integer)_datEntI13.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n33 = 0;
                        }
                        if (n33 == 14) {
                            ...
                            _center = new Vec3(x + entity.m_20154_().f_82479_ * 48.0, y, z + entity.m_20154_().f_82481_ * 48.0);
                            _entfound = world.m_6443_(Entity.class, new AABB(_center, _center).m_82400_(150.0), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.m_20238_(_center))).toList();
                            for (Entity entity4 : _entfound) {
                                ...
                                float f51;
                                float f52;
                                if (entity4 instanceof BedrockgolemtitanEntity || !(entity4 instanceof LivingEntity)) continue;
                                DamageSource damageSource = new DamageSource((Holder)world.m_9598_().m_175515_(Registries.f_268580_).m_246971_(DamageTypes.f_268724_), entity, entity);
                                if (entity4 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity4;
                                    f52 = _livEnt3.m_21233_();
                                } else {
                                    f52 = -1.0f;
                                }
                                entity4.m_6469_(damageSource, f52 / 20.0f + 4200000.0f);
                                ...
                                if (entity4 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity4;
                                    f51 = _livEnt3.m_21233_();
                                } else {
                                    f51 = -1.0f;
                                }
                                entity4.m_6469_(damageSource14, f51 / 20.0f + 4200000.0f);
                                ...
                                if (entity4 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity4;
                                    f50 = _livEnt3.m_21233_();
                                } else {
                                    f50 = -1.0f;
                                }
                                entity4.m_6469_(damageSource15, f50 / 20.0f + 4200000.0f);
                                ...
                                if (entity4 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity4;
                                    f48 = _livEnt3.m_21223_();
                                } else {
                                    f48 = -1.0f;
                                }
                                entity4.m_6469_(damageSource16, (f49 + f48) / 5.0f + 4.2E7f);
                                ...
                                if (entity4 instanceof LivingEntity) {
                                    _livEnt3 = (LivingEntity)entity4;
                                    f46 = _livEnt3.m_21223_();
                                } else {
                                    f46 = -1.0f;
                                }
                                entity4.m_6469_(damageSource17, (f47 + f46) / 5.0f + 4.2E7f);
                            }
                        }
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI14 = (BedrockgolemtitanEntity)entity;
                            n32 = (Integer)_datEntI14.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n32 = 0;
                        }
                        if (n32 >= 30) {
                    ...
                    if (entity instanceof BedrockgolemtitanEntity) {
                        _datEntI = (BedrockgolemtitanEntity)entity;
                        n7 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                    } else {
                        n7 = 0;
                    }
                    if (n7 == 5) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.fs2");
                        }
                        if (entity instanceof Mob) {
                            Mob _mobEnt20 = (Mob)entity;
                            livingEntity70 = _mobEnt20.m_5448_();
                        } else {
                            livingEntity70 = null;
                        }
                        if (livingEntity70 != null) {
                            ...
                            f53 = entity.m_20270_(livingEntity71);
                        } else {
                            f53 = -1.0f;
                        }
                        if (f53 > 1.0f) {
                        ...
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI15 = (BedrockgolemtitanEntity)entity;
                            n35 = (Integer)_datEntI15.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n35 = 0;
                        }
                        if (n35 == 40) {
                            ...
                            if (world instanceof ServerLevel) {
                                ...
                                entityToSpawn = ((EntityType)UltimateskeletonsModEntities.ADMINIUMSHOCK.get()).m_262496_((ServerLevel)_level, BlockPos.m_274561_((double)(x + entity.m_20154_().f_82479_ * 120.0), (double)y, (double)(z + entity.m_20154_().f_82481_ * 120.0)), MobSpawnType.MOB_SUMMONED);
                                if (entityToSpawn != null) {
                                    entityToSpawn.m_146922_(world.m_213780_().m_188501_() * 360.0f);
                                }
                            }
                            _center = new Vec3(x + entity.m_20154_().f_82479_ * 80.0, y, z + entity.m_20154_().f_82481_ * 80.0);
                            _entfound = world.m_6443_(Entity.class, new AABB(_center, _center).m_82400_(512.0), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.m_20238_(_center))).toList();
                            for (Entity entity5 : _entfound) {
                                ...
                                float f59;
                                float f60;
                                if (entity5 instanceof BedrockgolemtitanEntity || !(entity5 instanceof LivingEntity)) continue;
                                double _setval = 8.0;
                                ...
                                if (entity5 instanceof LivingEntity) {
                                    ...
                                    f60 = _livEnt7.m_21233_();
                                } else {
                                    f60 = -1.0f;
                                }
                                entity5.m_6469_(damageSource, f60 / 20.0f + 8400000.0f);
                                ...
                                entity5.m_6469_(damageSource18, f59 / 20.0f + 8400000.0f);
                                ...
                                if (entity5 instanceof LivingEntity) {
                                    ...
                                    f58 = _livEnt9.m_21233_();
                                } else {
                                    f58 = -1.0f;
                                }
                                entity5.m_6469_(damageSource19, f58 / 20.0f + 8400000.0f);
                                ...
                                if (entity5 instanceof LivingEntity) {
                                    ...
                                    f56 = _livEnt10.m_21223_();
                                } else {
                                    f56 = -1.0f;
                                }
                                entity5.m_6469_(damageSource20, (f57 + f56) / 5.0f + 8400000.0f);
                                ...
                                if (entity5 instanceof LivingEntity) {
                                    ...
                                    f54 = _livEnt11.m_21223_();
                                } else {
                                    f54 = -1.0f;
                                }
                                entity5.m_6469_(damageSource21, (f55 + f54) / 5.0f + 8400000.0f);
                            }
                        }
                        if (entity instanceof BedrockgolemtitanEntity) {
                            BedrockgolemtitanEntity _datEntI16 = (BedrockgolemtitanEntity)entity;
                            n34 = (Integer)_datEntI16.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                        } else {
                            n34 = 0;
                        }
                        if (n34 >= 60) {
                    ...
                    if (entity instanceof BedrockgolemtitanEntity) {
                        _datEntI = (BedrockgolemtitanEntity)entity;
                        n6 = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
                    } else {
                        n6 = 0;
                    }
                    if (n6 != 6) break block593;
                    if (entity instanceof BedrockgolemtitanEntity) {
                        ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.hammer");
                    }
                    if (entity instanceof Mob) {
                    ...
                    if (f > 1.0f) {
                        ...
                        double d23 = livingEntity79.m_20186_();
                        if (entity instanceof Mob) {
                            _mobEnt = (Mob)entity;
                        ...
                        double d24 = d23 + (double)livingEntity78.m_20206_() / 1.5;
                        if (entity instanceof Mob) {
                            _mobEnt = (Mob)entity;
                        ...
                        entity.m_7618_(EntityAnchorArgument.Anchor.EYES, new Vec3(d, d24, livingEntity77.m_20189_()));
                    }
                    if (entity instanceof BedrockgolemtitanEntity) {
                        BedrockgolemtitanEntity _datEntI17 = (BedrockgolemtitanEntity)entity;
                        n5 = (Integer)_datEntI17.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                    } else {
                        n5 = 0;
                    }
                    if (n5 == 12) break block594;
                    if (entity instanceof BedrockgolemtitanEntity) {
                        _datEntI2 = (BedrockgolemtitanEntity)entity;
                        n4 = (Integer)_datEntI2.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
                    } else {
                        n4 = 0;
                    }
                    if (n4 != 53) break block595;
                }
                if (world instanceof Level) {
                    _level2 = (Level)world;
                    if (!_level2.m_5776_()) {
                        _level2.m_5594_(null, BlockPos.m_274561_((double)x, (double)y, (double)z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:swing")), SoundSource.NEUTRAL, 200.0f, 1.0f);
                    } else {
                        _level2.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:swing")), SoundSource.NEUTRAL, 200.0f, 1.0f, false);
                    }
                }
                Vec3 _center2 = new Vec3(x + entity.m_20154_().f_82479_ * 60.0, y, z + entity.m_20154_().f_82481_ * 60.0);
                List<Entity> _entfound2 = world.m_6443_(Entity.class, new AABB(_center2, _center2).m_82400_(250.0), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.m_20238_(_center2))).toList();
                Iterator<Entity> iterator = _entfound2.iterator();
                while (iterator.hasNext()) {
                    ...
                    float f65;
                    float f66;
                    Entity entityiterator = iterator.next();
                    if (entityiterator instanceof BedrockgolemtitanEntity || !(entityiterator instanceof LivingEntity)) continue;
                    double _setval = 5.0;
                    ...
                    if (entityiterator instanceof LivingEntity) {
                        ...
                        f66 = _livEnt12.m_21233_();
                    } else {
                        f66 = -1.0f;
                    }
                    entityiterator.m_6469_(damageSource, f66 / 20.0f + 4200000.0f);
                    ...
                    if (entityiterator instanceof LivingEntity) {
                        ...
                        f65 = _livEnt13.m_21233_();
                    } else {
                        f65 = -1.0f;
                    }
                    entityiterator.m_6469_(damageSource22, f65 / 20.0f + 4200000.0f);
                    ...
                    if (entityiterator instanceof LivingEntity) {
                        ...
                        f64 = _livEnt14.m_21233_();
                    } else {
                        f64 = -1.0f;
                    }
                    entityiterator.m_6469_(damageSource23, f64 / 20.0f + 4200000.0f);
                    ...
                    if (entityiterator instanceof LivingEntity) {
                        ...
                        f62 = _livEnt15.m_21223_();
                    } else {
                        f62 = -1.0f;
                    }
                    entityiterator.m_6469_(damageSource24, (f63 + f62) / 5.0f + 4.2E7f);
                    ...
                    if (entityiterator instanceof LivingEntity) {
                        ...
                        f = _livEnt16.m_21223_();
                    } else {
                        f = -1.0f;
                    }
                    entityiterator.m_6469_(damageSource25, (f61 + f) / 5.0f + 4.2E7f);
                }
            }
            if (entity instanceof BedrockgolemtitanEntity) {
                BedrockgolemtitanEntity _datEntI18 = (BedrockgolemtitanEntity)entity;
                n3 = (Integer)_datEntI18.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
            } else {
                n3 = 0;
            }
            if (n3 == 81) {
                if (world instanceof Level) {
                    _level = (Level)world;
                    if (!_level.m_5776_()) {
                        _level.m_5594_(null, BlockPos.m_274561_((double)x, (double)y, (double)z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:strike")), SoundSource.NEUTRAL, 40.0f, 1.0f);
                    } else {
                        _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:strike")), SoundSource.NEUTRAL, 40.0f, 1.0f, false);
                    }
                }
                if (world instanceof ServerLevel) {
                    _level = (ServerLevel)world;
                    entityToSpawn = ((EntityType)UltimateskeletonsModEntities.ADMINIUMSHOCK.get()).m_262496_((ServerLevel)_level, BlockPos.m_274561_((double)(x + entity.m_20154_().f_82479_ * 90.0), (double)y, (double)(z + entity.m_20154_().f_82481_ * 90.0)), MobSpawnType.MOB_SUMMONED);
                    if (entityToSpawn != null) {
                        entityToSpawn.m_146922_(world.m_213780_().m_188501_() * 360.0f);
                    }
                }
                ...
                for (Entity entity6 : _entfound) {
                    ...
                    float f71;
                    float f72;
                    if (entity6 instanceof BedrockgolemtitanEntity || !(entity6 instanceof LivingEntity)) continue;
                    double _setval = 10.0;
                    ...
                    if (entity6 instanceof LivingEntity) {
                        ...
                        f72 = _livEnt17.m_21233_();
                    } else {
                        f72 = -1.0f;
                    }
                    entity6.m_6469_(damageSource, f72 / 20.0f + 8400000.0f);
                    ...
                    if (entity6 instanceof LivingEntity) {
                        ...
                        f71 = _livEnt18.m_21233_();
                    } else {
                        f71 = -1.0f;
                    }
                    entity6.m_6469_(damageSource26, f71 / 20.0f + 8400000.0f);
                    ...
                    if (entity6 instanceof LivingEntity) {
                        LivingEntity _livEnt19 = (LivingEntity)entity6;
                        f70 = _livEnt19.m_21233_();
                    } else {
                        f70 = -1.0f;
                    }
                    entity6.m_6469_(damageSource27, f70 / 20.0f + 8400000.0f);
                    ...
                    if (entity6 instanceof LivingEntity) {
                        LivingEntity _livEnt20 = (LivingEntity)entity6;
                        f68 = _livEnt20.m_21223_();
                    } else {
                        f68 = -1.0f;
                    }
                    entity6.m_6469_(damageSource28, (f69 + f68) / 5.0f + 8400000.0f);
                    ...
                    if (entity6 instanceof LivingEntity) {
                        LivingEntity _livEnt21 = (LivingEntity)entity6;
                        f = _livEnt21.m_21223_();
                    } else {
                        f = -1.0f;
                    }
                    entity6.m_6469_(damageSource29, (f67 + f) / 5.0f + 8400000.0f);
                }
            }
            if (entity instanceof BedrockgolemtitanEntity) {
                BedrockgolemtitanEntity _datEntI19 = (BedrockgolemtitanEntity)entity;
                n2 = (Integer)_datEntI19.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
            } else {
                n2 = 0;
            }
            if (n2 >= 110) {
        ...
        if (entity instanceof BedrockgolemtitanEntity) {
            _datEntI = (BedrockgolemtitanEntity)entity;
            n = (Integer)_datEntI.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationID);
        } else {
            n = 0;
        }
        if (n == 7) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof BedrockgolemtitanEntity) {
                ((BedrockgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.td");
            }
            if (entity instanceof Mob) {
                Mob _mobEnt22 = (Mob)entity;
            ...
            if (f > 1.0f) {
                ...
                double d25 = livingEntity84.m_20186_();
                if (entity instanceof Mob) {
                    _mobEnt = (Mob)entity;
                ...
                double d26 = d25 + (double)livingEntity83.m_20206_() / 1.5;
                if (entity instanceof Mob) {
                    _mobEnt = (Mob)entity;
                ...
                entity.m_7618_(EntityAnchorArgument.Anchor.EYES, new Vec3(d, d26, livingEntity82.m_20189_()));
            }
            if (entity instanceof BedrockgolemtitanEntity) {
                BedrockgolemtitanEntity _datEntI20 = (BedrockgolemtitanEntity)entity;
                n37 = (Integer)_datEntI20.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
            } else {
                n37 = 0;
            }
            if (n37 == 18) {
                ...
                if (livingEntity86 != null) {
                    ...
                    f73 = entity.m_20270_(livingEntity87);
                } else {
                    f73 = -1.0f;
                }
                if (f73 > 1.0f && world instanceof ServerLevel) {
                    ...
                    Projectile projectile = new Object(){
                        ...
                        public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
                            GiantadminiumEntity entityToSpawn = new GiantadminiumEntity((EntityType<? extends GiantadminiumEntity>)((EntityType)UltimateskeletonsModEntities.GIANTADMINIUM.get()), level);
                    ...
                    projectile.m_6034_(x + entity.m_20154_().f_82479_ * 27.0, y + 50.0, z + entity.m_20154_().f_82481_ * 27.0);
                    if (entity instanceof Mob) {
                        _mobEnt2 = (Mob)entity;
                        livingEntity90 = _mobEnt2.m_5448_();
                    } else {
                        livingEntity90 = null;
                    }
                    double d = livingEntity90.m_20185_() - entity.m_20185_();
                    if (entity instanceof Mob) {
                        _mobEnt2 = (Mob)entity;
                    ...
                    double d27 = livingEntity89.m_20186_() - 45.0 - entity.m_20186_();
                    if (entity instanceof Mob) {
                        _mobEnt2 = (Mob)entity;
                    ...
                    projectile.m_6686_(d, d27, livingEntity88.m_20189_() - entity.m_20189_(), 4.0f, 2.0f);
                    projectileLevel.m_7967_((Entity)projectile);
                }
            }
            if (entity instanceof BedrockgolemtitanEntity) {
                BedrockgolemtitanEntity _datEntI21 = (BedrockgolemtitanEntity)entity;
                n36 = (Integer)_datEntI21.m_20088_().m_135370_(BedrockgolemtitanEntity.DATA_animationTick);
            } else {
                n36 = 0;
            }
            if (n36 >= 49) {
