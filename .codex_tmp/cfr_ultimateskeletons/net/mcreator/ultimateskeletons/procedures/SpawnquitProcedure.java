...
public class SpawnquitProcedure {
    @SubscribeEvent
    public static void onEntitySpawned(EntityJoinLevelEvent event) {
        SpawnquitProcedure.execute((Event)event, (LevelAccessor)event.getLevel(), event.getEntity());
    }

    public static void execute(LevelAccessor world, Entity entity) {
        SpawnquitProcedure.execute(null, world, entity);
    }
    ...
    private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
        ...
        if (!(!UltimateskeletonsModVariables.MapVariables.get((LevelAccessor)world).spawnquit || entity instanceof Player || entity instanceof ChainEntity || entity instanceof DeathlaserEntity || entity instanceof DeathshockEntity || entity instanceof DeathskullEntity || entity instanceof DeathwitherbeamEntity || entity instanceof ElectricbombEntity || entity instanceof PushhandEntity || entity instanceof MultiversespaceEntity || entity instanceof SpaceEntity || entity instanceof UltimatedeathskullEntity || entity instanceof Slime || event == null || !event.isCancelable())) {
