...
public class DemontiumgolemtitanATKProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        Mob _mobEnt3;
        Mob _mobEnt4;
        DemontiumgolemtitanEntity _datEntSetI;
        Level _level;
        DemontiumgolemtitanEntity _datEntI;
        block511: {
            int n6;
            block513: {
                Level _level2;
                block512: {
                    ...
                    int n9;
                    DemontiumgolemtitanEntity _datEntI2;
                    block508: {
                        LivingEntity livingEntity2;
                        LivingEntity _livEnt3;
                        Mob _mobEnt5;
                        DemontiumgolemtitanEntity _datEntI3;
                        block509: {
                            block510: {
                                ...
                                DemontiumgolemtitanEntity _datEntI4;
                                ...
                                if (entity instanceof DemontiumgolemtitanEntity) {
                                    int n11;
                                    DemontiumgolemtitanEntity _datEntSetI2 = (DemontiumgolemtitanEntity)entity;
                                    SynchedEntityData synchedEntityData = _datEntSetI2.m_20088_();
                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                        _datEntI4 = (DemontiumgolemtitanEntity)entity;
                                        n11 = (Integer)_datEntI4.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_spawnTick);
                                    } else {
                                        n11 = 0;
                                    }
                                    synchedEntityData.m_135381_(DemontiumgolemtitanEntity.DATA_spawnTick, (Object)(n11 + 1));
                                }
                                if (entity.m_5446_().getString().equals("growing")) {
                                    int n12;
                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                        _datEntI = (DemontiumgolemtitanEntity)entity;
                                        n12 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_spawnTick);
                                    } else {
                                        n12 = 0;
                                    }
                                    if (n12 <= 720) {
                                        ...
                                        if (entity instanceof DemontiumgolemtitanEntity) {
                                            _datEntI4 = (DemontiumgolemtitanEntity)entity;
                                            n14 = (Integer)_datEntI4.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_spawnTick);
                                        } else {
                                            n14 = 0;
                                        }
                                        if (n14 <= 10 && entity instanceof DemontiumgolemtitanEntity) {
                                            ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.spawn");
                                        }
                                        if (entity instanceof DemontiumgolemtitanEntity) {
                                            _datEntI4 = (DemontiumgolemtitanEntity)entity;
                                            n13 = (Integer)_datEntI4.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_spawnTick);
                                        } else {
                                            n13 = 0;
                                        }
                                        if (n13 == 720) {
                                            ...
                                            if (!world.m_5776_() && world.m_7654_() != null) {
                                                world.m_7654_().m_6846_().m_240416_((Component)Component.m_237113_((String)"Demontiumgolemtitan has been created!!!"), false);
                                            }
                                        }
                                ...
                                if (!world.m_5776_()) {
                                    ...
                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                        _datEntI = (DemontiumgolemtitanEntity)entity;
                                        n15 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
                                    } else {
                                        n15 = 0;
                                    }
                                    if (n15 != 0) {
                                        ...
                                        if (f5 <= 0.0f) {
                                            for (int index0 = 0; index0 < 16; ++index0) {
                                                if (!(entity instanceof DemontiumgolemtitanEntity)) continue;
                                                ((DemontiumgolemtitanEntity)entity).setAnimation("empty");
                                            }
                                        }
                                    }
                                }
                                ...
                                if (f4 > 0.0f) {
                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                        DemontiumgolemtitanEntity _datEntSetI3 = (DemontiumgolemtitanEntity)entity;
                                        _datEntSetI3.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_deathTick, (Object)0);
                                    }
                                    for (int index1 = 0; index1 < 24; ++index1) {
                                        world.m_7106_((ParticleOptions)ParticleTypes.f_123760_, x + Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0) * (double)entity.m_20205_(), y + Math.random() * (double)entity.m_20206_(), z + Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)-1.0, (double)1.0) * (double)entity.m_20205_(), 0.0, 0.0, 0.0);
                                    }
                                }
                                if (entity instanceof LivingEntity) {
                                    _livEnt4 = (LivingEntity)entity;
                                ...
                                if (f3 <= 0.0f) {
                                    ...
                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                        DemontiumgolemtitanEntity _datEntI5 = (DemontiumgolemtitanEntity)entity;
                                        n16 = (Integer)_datEntI5.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
                                    } else {
                                        n16 = 0;
                                    }
                                    if (n16 == 0) {
                                        ...
                                        if (entity instanceof DemontiumgolemtitanEntity) {
                                            int n19;
                                            _datEntSetI = (DemontiumgolemtitanEntity)entity;
                                            SynchedEntityData synchedEntityData = _datEntSetI.m_20088_();
                                            if (entity instanceof DemontiumgolemtitanEntity) {
                                                _datEntI3 = (DemontiumgolemtitanEntity)entity;
                                                n19 = (Integer)_datEntI3.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_deathTick);
                                            } else {
                                                n19 = 0;
                                            }
                                            synchedEntityData.m_135381_(DemontiumgolemtitanEntity.DATA_deathTick, (Object)(n19 + 1));
                                        }
                                        if (entity instanceof DemontiumgolemtitanEntity) {
                                            _datEntI2 = (DemontiumgolemtitanEntity)entity;
                                            n18 = (Integer)_datEntI2.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_deathTick);
                                        } else {
                                            n18 = 0;
                                        }
                                        ...
                                        if (entity instanceof DemontiumgolemtitanEntity) {
                                            ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.death");
                                        }
                                        if (entity instanceof DemontiumgolemtitanEntity) {
                                            _datEntI2 = (DemontiumgolemtitanEntity)entity;
                                            n17 = (Integer)_datEntI2.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_deathTick);
                                        } else {
                                            n17 = 0;
                                        }
                                ...
                                if (world.m_5776_()) break block508;
                                if (entity instanceof DemontiumgolemtitanEntity) {
                                    _datEntI = (DemontiumgolemtitanEntity)entity;
                                    n10 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
                                } else {
                                    n10 = 0;
                                }
                                if (n10 != 0 && entity instanceof DemontiumgolemtitanEntity) {
                                    int n20;
                                    DemontiumgolemtitanEntity _datEntSetI4 = (DemontiumgolemtitanEntity)entity;
                                    SynchedEntityData synchedEntityData = _datEntSetI4.m_20088_();
                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                        _datEntI2 = (DemontiumgolemtitanEntity)entity;
                                        n20 = (Integer)_datEntI2.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
                                    } else {
                                        n20 = 0;
                                    }
                                    synchedEntityData.m_135381_(DemontiumgolemtitanEntity.DATA_animationTick, (Object)(n20 + 1));
                                }
                                if (entity instanceof Mob) {
                                    _mobEnt5 = (Mob)entity;
                                ...
                                if (livingEntity5 == null) break block509;
                                if (entity instanceof Mob) {
                                ...
                                if (livingEntity3.m_6084_()) break block509;
                            }
                            if (entity instanceof Mob) {
                        ...
                        if (livingEntity2 != null) {
                            ...
                            if (f6 > 0.0f) {
                                ...
                                if (entity instanceof DemontiumgolemtitanEntity) {
                                    _datEntI3 = (DemontiumgolemtitanEntity)entity;
                                    n21 = (Integer)_datEntI3.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
                                } else {
                                    n21 = 0;
                                }
                                if (n21 == 0) {
                                    ...
                                    if (f7 < 512.0f) {
                                        DemontiumgolemtitanEntity _datEntSetI5;
                                        float f18;
                                        ...
                                        if (f18 <= 60.0f) {
                                            ...
                                            if (livingEntity41.m_20206_() > 6.0f) {
                                                if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)5) == 5) {
                                                    if (entity instanceof DemontiumgolemtitanEntity) {
                                                        _datEntSetI5 = (DemontiumgolemtitanEntity)entity;
                                                        _datEntSetI5.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationID, (Object)5);
                                                    }
                                                } else if (entity instanceof DemontiumgolemtitanEntity) {
                                                    _datEntSetI5 = (DemontiumgolemtitanEntity)entity;
                                                    _datEntSetI5.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationID, (Object)4);
                                                }
                                            } else if (entity instanceof DemontiumgolemtitanEntity) {
                                                _datEntSetI5 = (DemontiumgolemtitanEntity)entity;
                                                _datEntSetI5.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)3));
                                            }
                                        }
                                        if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)10) == 5) {
                                            int n22;
                                            if (entity instanceof DemontiumgolemtitanEntity) {
                                                DemontiumgolemtitanEntity _datEntI6 = (DemontiumgolemtitanEntity)entity;
                                                n22 = (Integer)_datEntI6.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
                                            } else {
                                                n22 = 0;
                                            }
                                            if (n22 == 0) {
                                                ...
                                                if (f19 > 80.0f) {
                                                    if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)30) == 5 && entity instanceof DemontiumgolemtitanEntity) {
                                                        _datEntSetI5 = (DemontiumgolemtitanEntity)entity;
                                                        _datEntSetI5.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationID, (Object)6);
                                                    }
                                                } else {
                                                    float f20;
                                                    ...
                                                    if (f20 > 60.0f && entity instanceof DemontiumgolemtitanEntity) {
                                                        DemontiumgolemtitanEntity _datEntSetI6 = (DemontiumgolemtitanEntity)entity;
                                                        _datEntSetI6.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationID, (Object)Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)5, (int)6));
                                                    }
                                                }
                                            }
                                        }
                    ...
                    if (entity instanceof DemontiumgolemtitanEntity) {
                        _datEntI = (DemontiumgolemtitanEntity)entity;
                        n9 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
                    } else {
                        n9 = 0;
                    }
                    if (n9 != true) break block511;
                    if (entity instanceof DemontiumgolemtitanEntity) {
                        ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.zt");
                    }
                    if (entity instanceof Mob) {
                    ...
                    if (entity instanceof DemontiumgolemtitanEntity) {
                        DemontiumgolemtitanEntity _datEntI7 = (DemontiumgolemtitanEntity)entity;
                        n8 = (Integer)_datEntI7.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
                    } else {
                        n8 = 0;
                    }
                    if (n8 == 56) break block512;
                    if (entity instanceof DemontiumgolemtitanEntity) {
                        _datEntI2 = (DemontiumgolemtitanEntity)entity;
                        n7 = (Integer)_datEntI2.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
                    } else {
                        n7 = 0;
                    }
                    if (n7 != 96) break block513;
                }
                if (world instanceof Level) {
                    _level2 = (Level)world;
                    if (!_level2.m_5776_()) {
                ...
                for (Entity entityiterator : _entfound2) {
                    ...
                    float f25;
                    float f26;
                    if (entityiterator instanceof DemontiumgolemtitanEntity || !(entityiterator instanceof LivingEntity)) continue;
                    ...
                    entityiterator.m_6469_(damageSource, f26 / 20.0f + 50000.0f);
                    ...
                    entityiterator.m_6469_(damageSource2, f25 / 20.0f + 50000.0f);
                    ...
                    entityiterator.m_6469_(damageSource3, f24 / 20.0f + 50000.0f);
                    ...
                    entityiterator.m_6469_(damageSource4, (f23 + f22) / 5.0f + 50000.0f);
                    ...
                    entityiterator.m_6469_(damageSource5, (f21 + f) / 5.0f + 50000.0f);
                }
            }
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI8 = (DemontiumgolemtitanEntity)entity;
                n6 = (Integer)_datEntI8.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n6 = 0;
            }
            if (n6 >= 120) {
                if (entity instanceof DemontiumgolemtitanEntity) {
                    _datEntSetI = (DemontiumgolemtitanEntity)entity;
                    _datEntSetI.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationID, (Object)0);
                }
                if (entity instanceof DemontiumgolemtitanEntity) {
                    _datEntSetI = (DemontiumgolemtitanEntity)entity;
                    _datEntSetI.m_20088_().m_135381_(DemontiumgolemtitanEntity.DATA_animationTick, (Object)0);
                }
                if (entity instanceof DemontiumgolemtitanEntity) {
                    ((DemontiumgolemtitanEntity)entity).setAnimation("empty");
                }
        ...
        if (entity instanceof DemontiumgolemtitanEntity) {
            _datEntI = (DemontiumgolemtitanEntity)entity;
            n5 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
        } else {
            n5 = 0;
        }
        if (n5 == 2) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof DemontiumgolemtitanEntity) {
                ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.zj");
            }
            if (entity instanceof Mob) {
            ...
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI9 = (DemontiumgolemtitanEntity)entity;
                n24 = (Integer)_datEntI9.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n24 = 0;
            }
            if (n24 == 36) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    entityiterator.m_6469_(damageSource, f33 / 20.0f + 50000.0f);
                    if (entityiterator instanceof Titangodentity) continue;
                    if (((Boolean)SkeletonsConfiguration.GOD.get()).booleanValue() && !(entityiterator instanceof Player)) {
                        entityiterator.f_19802_ = 0;
                        Deathlist.normalattack(entityiterator);
                    ...
                    entityiterator.m_6469_(damageSource6, f32 / 20.0f + 50000.0f);
                    ...
                    entityiterator.m_6469_(damageSource7, f31 / 20.0f + 50000.0f);
                    entityiterator.m_20256_(new Vec3(0.0, 1.0, 0.0));
                    if (!(entityiterator.m_20206_() > 6.0f)) continue;
                    ...
                    entityiterator.m_6469_(damageSource8, (f30 + f29) / 5.0f + 500000.0f);
                    ...
                    entityiterator.m_6469_(damageSource9, (f28 + f27) / 5.0f + 500000.0f);
                }
            }
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI10 = (DemontiumgolemtitanEntity)entity;
                n23 = (Integer)_datEntI10.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n23 = 0;
            }
            if (n23 >= 60) {
        ...
        if (entity instanceof DemontiumgolemtitanEntity) {
            _datEntI = (DemontiumgolemtitanEntity)entity;
            n4 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
        } else {
            n4 = 0;
        }
        if (n4 == 3) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof DemontiumgolemtitanEntity) {
                ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.gt");
            }
            if (entity instanceof Mob) {
            ...
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI11 = (DemontiumgolemtitanEntity)entity;
                n26 = (Integer)_datEntI11.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n26 = 0;
            }
            if (n26 == 48) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    entityiterator.m_6469_(damageSource, f40 / 20.0f + 105000.0f);
                    if (entityiterator instanceof Titangodentity) continue;
                    if (((Boolean)SkeletonsConfiguration.GOD.get()).booleanValue() && !(entityiterator instanceof Player)) {
                        entityiterator.f_19802_ = 0;
                        Deathlist.normalattack(entityiterator);
                    ...
                    entityiterator.m_6469_(damageSource10, f39 / 20.0f + 105000.0f);
                    ...
                    entityiterator.m_6469_(damageSource11, f38 / 20.0f + 105000.0f);
                    entityiterator.m_20256_(new Vec3(0.0, 1.0, 0.0));
                    if (!(entityiterator.m_20206_() > 6.0f)) continue;
                    ...
                    entityiterator.m_6469_(damageSource12, (f37 + f36) / 5.0f + 1050000.0f);
                    ...
                    entityiterator.m_6469_(damageSource13, (f35 + f34) / 5.0f + 1050000.0f);
                }
            }
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI12 = (DemontiumgolemtitanEntity)entity;
                n25 = (Integer)_datEntI12.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n25 = 0;
            }
            if (n25 >= 80) {
        ...
        if (entity instanceof DemontiumgolemtitanEntity) {
            _datEntI = (DemontiumgolemtitanEntity)entity;
            n3 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
        } else {
            n3 = 0;
        }
        if (n3 == 4) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof DemontiumgolemtitanEntity) {
                ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.attack");
            }
            if (entity instanceof Mob) {
            ...
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI13 = (DemontiumgolemtitanEntity)entity;
                n28 = (Integer)_datEntI13.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n28 = 0;
            }
            if (n28 == 14) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    entityiterator.m_6469_(damageSource, f47 / 20.0f + 210000.0f);
                    if (entityiterator instanceof Titangodentity) continue;
                    if (((Boolean)SkeletonsConfiguration.GOD.get()).booleanValue() && !(entityiterator instanceof Player)) {
                        entityiterator.f_19802_ = 0;
                        Deathlist.normalattack(entityiterator);
                    ...
                    entityiterator.m_6469_(damageSource14, f46 / 20.0f + 210000.0f);
                    ...
                    entityiterator.m_6469_(damageSource15, f45 / 20.0f + 210000.0f);
                    if (!(entityiterator.m_20206_() > 6.0f)) continue;
                    ...
                    entityiterator.m_6469_(damageSource16, (f44 + f43) / 5.0f + 2100000.0f);
                    ...
                    entityiterator.m_6469_(damageSource17, (f42 + f41) / 5.0f + 2100000.0f);
                }
            }
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI14 = (DemontiumgolemtitanEntity)entity;
                n27 = (Integer)_datEntI14.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n27 = 0;
            }
            if (n27 >= 30) {
        ...
        if (entity instanceof DemontiumgolemtitanEntity) {
            _datEntI = (DemontiumgolemtitanEntity)entity;
            n2 = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
        } else {
            n2 = 0;
        }
        if (n2 == 5) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof DemontiumgolemtitanEntity) {
                ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.fs");
            }
            if (entity instanceof Mob) {
            ...
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI15 = (DemontiumgolemtitanEntity)entity;
                n30 = (Integer)_datEntI15.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n30 = 0;
            }
            if (n30 == 40) {
                ...
                for (Entity entityiterator : _entfound) {
                    ...
                    entityiterator.m_6469_(damageSource, f54 / 20.0f + 420000.0f);
                    if (entityiterator instanceof Titangodentity) continue;
                    if (((Boolean)SkeletonsConfiguration.GOD.get()).booleanValue() && !(entityiterator instanceof Player)) {
                        entityiterator.f_19802_ = 0;
                        Deathlist.normalattack(entityiterator);
                    ...
                    entityiterator.m_6469_(damageSource18, f53 / 20.0f + 420000.0f);
                    ...
                    entityiterator.m_6469_(damageSource19, f52 / 20.0f + 420000.0f);
                    entityiterator.m_20256_(new Vec3(0.0, 1.0, 0.0));
                    if (!(entityiterator.m_20206_() > 6.0f)) continue;
                    ...
                    entityiterator.m_6469_(damageSource20, (f51 + f50) / 5.0f + 4200000.0f);
                    ...
                    entityiterator.m_6469_(damageSource21, (f49 + f48) / 5.0f + 4200000.0f);
                }
            }
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI16 = (DemontiumgolemtitanEntity)entity;
                n29 = (Integer)_datEntI16.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n29 = 0;
            }
            if (n29 >= 60) {
        ...
        if (entity instanceof DemontiumgolemtitanEntity) {
            _datEntI = (DemontiumgolemtitanEntity)entity;
            n = (Integer)_datEntI.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationID);
        } else {
            n = 0;
        }
        if (n == 6) {
            ...
            LivingEntity livingEntity;
            if (entity instanceof DemontiumgolemtitanEntity) {
                ((DemontiumgolemtitanEntity)entity).setAnimation("animation.irongolemtitan.td");
            }
            if (entity instanceof Mob) {
            ...
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI17 = (DemontiumgolemtitanEntity)entity;
                n32 = (Integer)_datEntI17.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n32 = 0;
            }
            if (n32 == 18) {
                ...
                if (f55 > 1.0f && world instanceof ServerLevel) {
                    ...
                    Projectile _entityToSpawn = new Object(){
                        ...
                        public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
                            GiantdemontiumEntity entityToSpawn = new GiantdemontiumEntity((EntityType<? extends GiantdemontiumEntity>)((EntityType)UltimateskeletonsModEntities.GIANTDEMONTIUM.get()), level);
            ...
            if (entity instanceof DemontiumgolemtitanEntity) {
                DemontiumgolemtitanEntity _datEntI18 = (DemontiumgolemtitanEntity)entity;
                n31 = (Integer)_datEntI18.m_20088_().m_135370_(DemontiumgolemtitanEntity.DATA_animationTick);
            } else {
                n31 = 0;
            }
            if (n31 >= 50) {
