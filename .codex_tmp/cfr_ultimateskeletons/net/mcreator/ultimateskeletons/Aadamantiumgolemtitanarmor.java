...
public class Aadamantiumgolemtitanarmor
extends GeoRenderLayer<AdamantiumgolemtitanEntity> {
    public Aadamantiumgolemtitanarmor(GeoRenderer<AdamantiumgolemtitanEntity> entityRenderer) {
    ...
    protected ResourceLocation getTextureLocation() {
        return new ResourceLocation("ultimateskeletons:textures/entities/redenchant.png");
    }
}
