...
public class SwordedgecutRenderer
extends EntityRenderer<SwordedgecutEntity> {
    ...
    public SwordedgecutRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new Modelswordedge(context.m_174023_(Modelswordedge.LAYER_LOCATION));
    }

    public void render(SwordedgecutEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(SwordedgecutEntity entity) {
        return texture;
    }
}
