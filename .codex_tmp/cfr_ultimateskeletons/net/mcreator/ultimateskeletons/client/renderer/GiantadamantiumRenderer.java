...
public class GiantadamantiumRenderer
extends EntityRenderer<GiantadamantiumEntity> {
    private static final ResourceLocation texture = new ResourceLocation("ultimateskeletons:textures/item/adamantium.png");
    private static final RenderType RENDER_TYPE = RenderType.m_110458_((ResourceLocation)texture);

    public GiantadamantiumRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    public int getBlockLightLevel(GiantadamantiumEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(GiantadamantiumEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.m_85836_();
        ...
        GiantadamantiumRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 0, 0, 1);
        GiantadamantiumRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 0, 1, 1);
        GiantadamantiumRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 1, 1, 0);
        GiantadamantiumRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 1, 0, 0);
        p_114083_.m_85849_();
    ...
    public ResourceLocation getTextureLocation(GiantadamantiumEntity p_114078_) {
        return texture;
    }
}
