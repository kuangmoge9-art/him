...
public class ChaoslightningballRenderer
extends EntityRenderer<ChaoslightningballEntity> {
    ...
    public ChaoslightningballRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public void render(ChaoslightningballEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffers, int packedLight) {
        poseStack.m_85836_();
        float $10 = (float)entity.f_19797_ + partialTicks;
        float radius = 10.0f + Mth.m_14031_((float)(((float)entity.f_19797_ + partialTicks) * 0.1f)) * 2.0f;
    ...
    public ResourceLocation getTextureLocation(ChaoslightningballEntity entity) {
        return texture;
    }
}
