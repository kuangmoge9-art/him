...
public class GiantdemontiumRenderer
extends EntityRenderer<GiantdemontiumEntity> {
    private static final ResourceLocation texture = new ResourceLocation("ultimateskeletons:textures/item/demontiumingot.png");
    private static final RenderType RENDER_TYPE = RenderType.m_110458_((ResourceLocation)texture);

    public GiantdemontiumRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    public int getBlockLightLevel(GiantdemontiumEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(GiantdemontiumEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.m_85836_();
        ...
        GiantdemontiumRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 0, 0, 1);
        GiantdemontiumRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 0, 1, 1);
        GiantdemontiumRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 1, 1, 0);
        GiantdemontiumRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 1, 0, 0);
        p_114083_.m_85849_();
    ...
    public ResourceLocation getTextureLocation(GiantdemontiumEntity p_114078_) {
        return texture;
    }
}
