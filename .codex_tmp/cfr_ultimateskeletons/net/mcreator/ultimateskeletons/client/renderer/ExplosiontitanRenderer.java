...
public class ExplosiontitanRenderer
extends HumanoidMobRenderer<ExplosiontitanEntity, HumanoidModel<ExplosiontitanEntity>> {
    public ExplosiontitanRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(ExplosiontitanEntity entity) {
