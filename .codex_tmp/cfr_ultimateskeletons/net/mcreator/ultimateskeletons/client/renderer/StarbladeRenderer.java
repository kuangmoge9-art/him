...
public class StarbladeRenderer
extends EntityRenderer<StarbladeEntity> {
    private static final ResourceLocation texture = new ResourceLocation("ultimateskeletons:textures/entities/xing_he_chang_qiang_.png");
    private final Modelstarblade model;

    public StarbladeRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new Modelstarblade(context.m_174023_(Modelstarblade.LAYER_LOCATION));
    }

    public boolean shouldRender(StarbladeEntity p_114491_, Frustum p_114492_, double p_114493_, double p_114494_, double p_114495_) {
        return true;
    }

    public void render(StarbladeEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(StarbladeEntity entity) {
        return texture;
    }
}
