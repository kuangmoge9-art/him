...
public class GiantadminiumRenderer
extends EntityRenderer<GiantadminiumEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("ultimateskeletons:textures/block/bedrock_compact.png");
    private static final RenderType RENDER_TYPE = RenderType.m_110458_((ResourceLocation)TEXTURE_LOCATION);

    public GiantadminiumRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    public int getBlockLightLevel(GiantadminiumEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(GiantadminiumEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.m_85836_();
        ...
        GiantadminiumRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 0, 0, 1);
        GiantadminiumRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 0, 1, 1);
        GiantadminiumRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 1, 1, 0);
        GiantadminiumRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 1, 0, 0);
        p_114083_.m_85849_();
    ...
    public ResourceLocation getTextureLocation(GiantadminiumEntity p_114078_) {
