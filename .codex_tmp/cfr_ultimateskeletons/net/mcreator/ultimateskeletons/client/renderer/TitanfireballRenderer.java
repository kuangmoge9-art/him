...
public class TitanfireballRenderer
extends EntityRenderer<TitanfireballEntity> {
    private static final ResourceLocation texture = new ResourceLocation("ultimateskeletons:textures/particle/giantfirecharge.png");
    private static final RenderType RENDER_TYPE = RenderType.m_110458_((ResourceLocation)texture);
    private final Modelswordedgeslash model;

    public TitanfireballRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new Modelswordedgeslash(context.m_174023_(Modelswordedgeslash.LAYER_LOCATION));
    }

    public void render(TitanfireballEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.m_85836_();
        p_114083_.m_85841_(32.0f, 32.0f, 32.0f);
        ...
        TitanfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 0, 0, 1);
        TitanfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 0, 1, 1);
        TitanfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 1, 1, 0);
        TitanfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 1, 0, 0);
        p_114083_.m_85849_();
    ...
    public ResourceLocation getTextureLocation(TitanfireballEntity entity) {
        return texture;
    }
}
