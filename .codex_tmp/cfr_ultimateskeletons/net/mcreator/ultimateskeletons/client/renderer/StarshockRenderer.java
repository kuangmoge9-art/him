...
public class StarshockRenderer
extends EntityRenderer<StarshockEntity> {
    private static final ResourceLocation texture = new ResourceLocation("ultimateskeletons:textures/entities/enchant.png");

    public StarshockRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    public boolean shouldRender(StarshockEntity p_114491_, Frustum p_114492_, double p_114493_, double p_114494_, double p_114495_) {
        return true;
    }
    ...
    public void render(StarshockEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        int g = 255 - entityIn.age * 12;
        int b = 255 - entityIn.age * 12;
        poseStack.m_85836_();
        ...
        for (int i = 0; i < segments; ++i) {
            ...
            for (int j = 0; j < segments * 2; ++j) {
                ...
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x4, y4, z4, r, g, b, packedLightIn, 1.0f, 1.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x3, y3, z3, r, g, b, packedLightIn, 1.0f, 0.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x2, y2, z2, r, g, b, packedLightIn, 0.0f, 0.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x1, y1, z1, r, g, b, packedLightIn, 0.0f, 1.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x1, y1, z1, r, g, b, packedLightIn, 0.0f, 1.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x2, y2, z2, r, g, b, packedLightIn, 0.0f, 0.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x3, y3, z3, r, g, b, packedLightIn, 1.0f, 0.0f);
                StarshockRenderer.vertex(buffer, matrix4f, matrix3f, x4, y4, z4, r, g, b, packedLightIn, 1.0f, 1.0f);
    ...
    private static void vertex(VertexConsumer vertexConsumer, Matrix4f matrix4f, Matrix3f matrix3f, float x, float y, float z, int red, int green, int blue, int light, float u, float v) {
        vertexConsumer.m_252986_(matrix4f, x, y, z).m_6122_(red, green, blue, 255).m_7421_(u, v).m_86008_(OverlayTexture.f_118083_).m_85969_(light).m_252939_(matrix3f, 0.6f, 1.0f, 0.8f).m_5752_();
    }

    public ResourceLocation getTextureLocation(StarshockEntity entity) {
        return texture;
    }
}
