...
public class GreenlightningRenderer
extends LightningBoltRenderer {
    ...
    public GreenlightningRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    private void mquad(Entity entity, Matrix4f p_253966_, VertexConsumer p_115274_, float p_115275_, float p_115276_, int p_115277_, float p_115278_, float p_115279_, float p_115280_, float p_115281_, float p_115282_, float p_115283_, float p_115284_, boolean p_115285_, boolean p_115286_, boolean p_115287_, boolean p_115288_) {
        ...
        if (entity instanceof GreenlightningEntity) {
            GreenlightningEntity purplelightning = (GreenlightningEntity)entity;
            float r = 0.0f;
            float g = 0.8f - (float)purplelightning.flashes * 0.01f;
            float b = 0.0f;
            float alpha = (float)purplelightning.flashes * 0.033f;
