...
public class SwordedgeslashRenderer
extends EntityRenderer<SwordedgeslashEntity> {
    private static final ResourceLocation texture = new ResourceLocation("ultimateskeletons:textures/entities/jian_qi_.png");
    private final Modelswordedgeslash model;

    public SwordedgeslashRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new Modelswordedgeslash(context.m_174023_(Modelswordedgeslash.LAYER_LOCATION));
    }

    public void render(SwordedgeslashEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(SwordedgeslashEntity entity) {
        return texture;
    }
}
