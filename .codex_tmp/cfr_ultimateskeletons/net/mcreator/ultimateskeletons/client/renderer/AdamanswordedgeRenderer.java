...
public class AdamanswordedgeRenderer
extends EntityRenderer<AdamanswordedgeEntity> {
    ...
    public AdamanswordedgeRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new Modelswordedge(context.m_174023_(Modelswordedge.LAYER_LOCATION));
    }

    public boolean shouldRender(AdamanswordedgeEntity p_114491_, Frustum p_114492_, double p_114493_, double p_114494_, double p_114495_) {
        return true;
    }

    public void render(AdamanswordedgeEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        this.model.m_7695_(poseStack, vb, packedLightIn, OverlayTexture.f_118083_, 1.0f, 0.0f, 0.0f, 1.0f);
        poseStack.m_85849_();
        super.m_7392_((Entity)entityIn, entityYaw, partialTicks, poseStack, bufferIn, packedLightIn);
    }

    public ResourceLocation getTextureLocation(AdamanswordedgeEntity entity) {
        return texture;
    }
}
