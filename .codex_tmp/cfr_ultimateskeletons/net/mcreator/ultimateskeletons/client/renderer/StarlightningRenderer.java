...
public class StarlightningRenderer
extends LightningBoltRenderer {
    ...
    public StarlightningRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    private void mquad(Entity entity, Matrix4f p_253966_, VertexConsumer p_115274_, float p_115275_, float p_115276_, int p_115277_, float p_115278_, float p_115279_, float p_115280_, float p_115281_, float p_115282_, float p_115283_, float p_115284_, boolean p_115285_, boolean p_115286_, boolean p_115287_, boolean p_115288_) {
        ...
        if (entity instanceof StarlightningEntity) {
            StarlightningEntity starlightning = (StarlightningEntity)entity;
            float r = (float)starlightning.flashes * 0.02f;
            float g = 0.4f + (float)starlightning.flashes * 0.012f;
            float b = 1.0f;
            float alpha = (float)starlightning.flashes * 0.033f;
