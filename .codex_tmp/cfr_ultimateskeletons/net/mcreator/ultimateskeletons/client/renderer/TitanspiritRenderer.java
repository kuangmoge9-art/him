...
public class TitanspiritRenderer
extends MobRenderer<TitanspiritEntity, SlimeModel<TitanspiritEntity>> {
    public TitanspiritRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new SlimeModel(context.m_174023_(ModelLayers.f_171241_)), 0.5f);
    }

    public ResourceLocation getTextureLocation(TitanspiritEntity entity) {
