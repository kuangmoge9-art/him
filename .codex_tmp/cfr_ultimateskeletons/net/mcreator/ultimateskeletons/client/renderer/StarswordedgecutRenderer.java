...
public class StarswordedgecutRenderer
extends EntityRenderer<StarswordedgecutEntity> {
    ...
    public StarswordedgecutRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new Modelswordedge(context.m_174023_(Modelswordedge.LAYER_LOCATION));
    }

    public void render(StarswordedgecutEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(StarswordedgecutEntity entity) {
        return texture;
    }
}
