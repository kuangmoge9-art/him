...
public class FlashballRenderer
extends EntityRenderer<FlashballEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("ultimateskeletons:textures/particle/rotten_flesh.png");
    private static final RenderType RENDER_TYPE = RenderType.m_110458_((ResourceLocation)TEXTURE_LOCATION);

    public FlashballRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }
    ...
    public void render(FlashballEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.m_85836_();
        p_114083_.m_85841_(6.0f, 6.0f, 6.0f);
        ...
        FlashballRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 0, 0, 1);
        FlashballRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 0, 1, 1);
        FlashballRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 1, 1, 0);
        FlashballRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 1, 0, 0);
        p_114083_.m_85849_();
    ...
    public ResourceLocation getTextureLocation(FlashballEntity p_114078_) {
