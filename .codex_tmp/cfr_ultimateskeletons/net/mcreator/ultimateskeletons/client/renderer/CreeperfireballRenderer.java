...
public class CreeperfireballRenderer
extends EntityRenderer<CreeperfireballEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("ultimateskeletons:textures/particle/giantgunpowder.png");
    private static final RenderType RENDER_TYPE = RenderType.m_110458_((ResourceLocation)TEXTURE_LOCATION);

    public CreeperfireballRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }
    ...
    public void render(CreeperfireballEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.m_85836_();
        ...
        CreeperfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 0, 0, 1);
        CreeperfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 0, 1, 1);
        CreeperfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 1.0f, 1, 1, 0);
        CreeperfireballRenderer.vertex($$9, $$7, $$8, p_114085_, 0.0f, 1, 0, 0);
        p_114083_.m_85849_();
    ...
    public ResourceLocation getTextureLocation(CreeperfireballEntity p_114078_) {
