...
public class MultiversewaveParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    public static MultiversewaveParticleProvider provider(SpriteSet spriteSet) {
        return new MultiversewaveParticleProvider(spriteSet);
    }

    protected MultiversewaveParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public void m_5744_(VertexConsumer p_107678_, Camera p_107679_, float p_107680_) {
        ...
        this.f_107663_ = 0.2f * (float)this.f_107224_;
    ...
    public static class MultiversewaveParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public MultiversewaveParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            MultiversewaveParticle particle = new MultiversewaveParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
