...
public class UlstarblastParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    public static UlstarblastParticleProvider provider(SpriteSet spriteSet) {
        return new UlstarblastParticleProvider(spriteSet);
    }

    protected UlstarblastParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
        this.spriteSet = spriteSet;
        this.m_107250_(0.2f, 0.2f);
        this.f_107663_ *= 256.0f;
        this.f_107225_ = 33;
        this.f_107226_ = 0.0f;
    ...
    public static class UlstarblastParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public UlstarblastParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            UlstarblastParticle particle = new UlstarblastParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
