...
public class DeathshineParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    public static DeathshineParticleProvider provider(SpriteSet spriteSet) {
        return new DeathshineParticleProvider(spriteSet);
    }

    protected DeathshineParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public static class DeathshineParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public DeathshineParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            DeathshineParticle particle = new DeathshineParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
