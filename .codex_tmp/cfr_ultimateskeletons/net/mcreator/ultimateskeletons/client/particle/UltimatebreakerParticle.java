...
public class UltimatebreakerParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    public static UltimatebreakerParticleProvider provider(SpriteSet spriteSet) {
        return new UltimatebreakerParticleProvider(spriteSet);
    }

    protected UltimatebreakerParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
        this.spriteSet = spriteSet;
        this.m_107250_(0.2f, 0.2f);
        this.f_107663_ *= 64.0f;
        this.f_107225_ = 50;
        this.f_107226_ = 0.0f;
    ...
    public void m_5744_(VertexConsumer p_107678_, Camera p_107679_, float p_107680_) {
        ...
        Vector3f[] avector3f = new Vector3f[]{new Vector3f(-6.0f, 0.0f, -6.0f), new Vector3f(-6.0f, 0.0f, 6.0f), new Vector3f(6.0f, 0.0f, 6.0f), new Vector3f(6.0f, 0.0f, -6.0f)};
    ...
    public void m_5989_() {
        super.m_5989_();
        if (!this.f_107220_) {
            this.m_108337_(this.spriteSet.m_5819_(this.f_107224_ / 1 % 51 + 1, 51));
        }
    }

    public static class UltimatebreakerParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public UltimatebreakerParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            UltimatebreakerParticle particle = new UltimatebreakerParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
