...
public class ShaParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    public static ShaParticleProvider provider(SpriteSet spriteSet) {
        return new ShaParticleProvider(spriteSet);
    }

    protected ShaParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public static class ShaParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public ShaParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ShaParticle particle = new ShaParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
