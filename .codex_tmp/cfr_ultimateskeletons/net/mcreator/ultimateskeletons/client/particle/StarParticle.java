...
extends TextureSheetParticle {
    ...
    protected StarParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        ...
        this.f_107663_ *= 2.0f;
        this.f_107225_ = Math.max(1, 22 + (this.f_107223_.m_188503_(4) - 2));
        this.f_107226_ = 0.0f;
    ...
    public void m_5989_() {
        super.m_5989_();
        if (!this.f_107220_) {
            this.m_108337_(this.spriteSet.m_5819_(this.f_107224_ / 1 % 25 + 1, 25));
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            StarParticle particle = new StarParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
