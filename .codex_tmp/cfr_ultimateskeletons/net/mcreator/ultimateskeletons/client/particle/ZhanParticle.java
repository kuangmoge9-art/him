...
public class ZhanParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    public static ZhanParticleProvider provider(SpriteSet spriteSet) {
        return new ZhanParticleProvider(spriteSet);
    }
    ...
    protected ZhanParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public static class ZhanParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public ZhanParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ZhanParticle particle = new ZhanParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
