...
extends TextureSheetParticle {
    ...
    protected FlameParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        ...
        this.f_107663_ *= (float)Mth.m_216263_((RandomSource)RandomSource.m_216327_(), (double)32.0, (double)64.0);
        this.f_107225_ = 33;
        this.f_107226_ = 0.0f;
    ...
    public static class FlameParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            FlameParticle particle = new FlameParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
