...
public class PanParticle
extends TextureSheetParticle {
    private final SpriteSet spriteSet;
    public int time = 0;
    public int size = 0;

    public static PanParticleProvider provider(SpriteSet spriteSet) {
        return new PanParticleProvider(spriteSet);
    }

    protected PanParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public void m_5744_(VertexConsumer p_107678_, Camera p_107679_, float p_107680_) {
        ...
        this.f_107663_ = (float)this.size * 0.4f;
        ...
        Quaternionf quaternionf = new Quaternionf(0.0f, 0.0f, 0.0f, (float)this.f_107224_ * 2.0f);
    ...
    public static class PanParticleProvider
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public PanParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            PanParticle particle = new PanParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
            return particle;
        }
    }
}
