...
public class Staruniverselayer
extends GeoRenderLayer<StarskeletonEntity> {
    ...
    public Staruniverselayer(GeoRenderer<StarskeletonEntity> entityRenderer) {
    ...
    public void render(PoseStack poseStack, StarskeletonEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        for (GeoBone bone : bakedModel.topLevelBones()) {
            if (bone.getName().equals("galaxy")) continue;
    ...
    public void renderForBone(PoseStack poseStack, StarskeletonEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        if (!bone.getName().equals("galaxy")) {
            RenderType glowRenderType = this.skyType;
            super.renderForBone(poseStack, (GeoAnimatable)animatable, bone, glowRenderType, bufferSource, buffer, partialTick, packedLight, packedOverlay);
        }
    }
}
