...
public class Witherskeletontitanarmor
extends GeoRenderLayer<WitherskeletontitanEntity> {
    public Witherskeletontitanarmor(GeoRenderer<WitherskeletontitanEntity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, WitherskeletontitanEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
