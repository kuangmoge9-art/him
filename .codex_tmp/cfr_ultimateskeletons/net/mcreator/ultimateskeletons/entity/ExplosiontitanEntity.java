...
import net.mcreator.ultimateskeletons.procedures.ExplosiontitanATKProcedure;
...
public class ExplosiontitanEntity
extends PathfinderMob {
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(ExplosiontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);

    public ExplosiontitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<ExplosiontitanEntity>)((EntityType)UltimateskeletonsModEntities.EXPLOSIONTITAN.get()), world);
    }

    public ExplosiontitanEntity(EntityType<ExplosiontitanEntity> type, Level world) {
        super(type, world);
        this.m_274367_(0.6f);
        this.f_21364_ = 0;
        this.m_21557_(false);
    ...
    public void m_6075_() {
        super.m_6075_();
        ExplosiontitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
    }
