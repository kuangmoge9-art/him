...
import net.mcreator.ultimateskeletons.procedures.StarskeletonATKProcedure;
import net.mcreator.ultimateskeletons.procedures.StarskeletonUltimateATKProcedure;
...
public class StarskeletonEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Boolean> DATA_God = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<Integer> DATA_GodTiclk = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_SkillCount = SynchedEntityData.m_135353_(StarskeletonEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public StarskeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<StarskeletonEntity>)((EntityType)UltimateskeletonsModEntities.STARSKELETON.get()), world);
    }

    public StarskeletonEntity(EntityType<StarskeletonEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
    ...
    public void m_21153_(float heal) {
        float healthafter = this.m_21223_() - 50.0f;
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(DATA_GodTiclk, (Object)0);
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128405_("DataGodTiclk", ((Integer)this.f_19804_.m_135370_(DATA_GodTiclk)).intValue());
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("DataGodTiclk")) {
            this.f_19804_.m_135381_(DATA_GodTiclk, (Object)compound.m_128451_("DataGodTiclk"));
        }
    ...
    public int getID() {
        return (Integer)this.f_19804_.m_135370_(DATA_GodTiclk);
    }
    ...
    public void m_6075_() {
        ...
        if (this.god) {
            this.hasTrail2 = true;
            StarskeletonUltimateATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        } else {
            this.hasTrail2 = false;
            StarskeletonATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        }
        this.m_6210_();
    }
