...
import net.mcreator.ultimateskeletons.procedures.ZombietitanATKProcedure;
...
public class ZombietitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_killCount = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Boolean> DATA_sword = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(ZombietitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public ZombietitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<ZombietitanEntity>)((EntityType)UltimateskeletonsModEntities.ZOMBIETITAN.get()), world);
    }

    public ZombietitanEntity(EntityType<ZombietitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(20000.0);
        this.set_health(20000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"zombie_titan");
        ...
        this.f_19804_.m_135372_(DATA_sword, (Object)false);
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:zombietitanidle"));
    }

    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:zombietitanidle")), 20.0f, 1.0f);
    }
    ...
    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:zombietitanhurt")), 20.0f, 1.0f);
    }

    public SoundEvent m_7975_(DamageSource ds) {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:zombietitanhurt"));
    }

    public SoundEvent m_5592_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:zombietitandeath"));
    }

    @Override
    public boolean m_6469_(DamageSource source, float amount) {
        if (this.getspawntick() > 510) {
            ...
            if (this.damageInvTime <= 0) {
                if (source.m_7640_() instanceof Titangodentity || source.m_7640_() instanceof Player) {
                    if (this.energy) {
                        this.set_health(this.get_health() - (double)amount * 0.08);
                    } else {
                        this.set_health(this.get_health() - (double)amount * 0.12);
                    }
                }
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128379_("Datasword", ((Boolean)this.f_19804_.m_135370_(DATA_sword)).booleanValue());
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("Datasword")) {
            this.f_19804_.m_135381_(DATA_sword, (Object)compound.m_128471_("Datasword"));
        }
    ...
    public boolean getsword() {
        return (Boolean)this.f_19804_.m_135370_(DATA_sword);
    }
    ...
    public void m_6075_() {
        ...
        if (this.get_health() < this.getMax_Health()) {
            if (this.get_health() >= 1.0) {
                this.set_health(this.get_health() + 15.0);
            } else {
                this.set_health(0.0);
            }
        }
        ...
        ZombietitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        if (this.getAnimatedID() == 6 && this.getAnimatedTick() <= 80 && this.getAnimatedTick() >= 40) {
            float ex = this.m_20205_();
            float fl = this.f_20883_ * ((float)Math.PI / 180);
            float fl1 = Mth.m_14031_((float)fl);
            float fl2 = Mth.m_14089_((float)fl);
            Vec3 leftPos = new Vec3(this.m_20185_() - (double)(fl2 * ex), this.m_20186_() + 0.96 * (double)this.m_20206_(), this.m_20189_() - (double)(fl1 * ex));
            LightningBolt entityToSpawn = (LightningBolt)EntityType.f_20465_.m_20615_(this.m_9236_());
            if (entityToSpawn != null) {
                entityToSpawn.m_20219_(leftPos);
            }
            GreenlightningEntity lightningBolt1 = new GreenlightningEntity((EntityType<GreenlightningEntity>)((EntityType)UltimateskeletonsModEntities.GREENLIGHTNING.get()), this.m_9236_());
            lightningBolt1.m_20219_(leftPos);
            this.m_9236_().m_7967_((Entity)lightningBolt1);
            Vec3 rightPos = new Vec3(this.m_20185_() + (double)(fl2 * ex), this.m_20186_() + 0.96 * (double)this.m_20206_(), this.m_20189_() + (double)(fl1 * ex));
            LightningBolt entityToSpawn2 = (LightningBolt)EntityType.f_20465_.m_20615_(this.m_9236_());
            if (entityToSpawn2 != null) {
                entityToSpawn2.m_20219_(rightPos);
            }
            GreenlightningEntity lightningBolt2 = new GreenlightningEntity((EntityType<GreenlightningEntity>)((EntityType)UltimateskeletonsModEntities.GREENLIGHTNING.get()), this.m_9236_());
            lightningBolt2.m_20219_(rightPos);
            this.m_9236_().m_7967_((Entity)lightningBolt2);
        }
        this.m_6210_();
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22284_, 22.0);
