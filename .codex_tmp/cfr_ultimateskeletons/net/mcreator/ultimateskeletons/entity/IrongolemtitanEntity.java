...
import net.mcreator.ultimateskeletons.procedures.IrongolemtitanATKProcedure;
...
public class IrongolemtitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(IrongolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public IrongolemtitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<IrongolemtitanEntity>)((EntityType)UltimateskeletonsModEntities.IRONGOLEMTITAN.get()), world);
    }

    public IrongolemtitanEntity(EntityType<IrongolemtitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 1;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(500000.0);
        this.setHEALTS(500000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"iron_golem_titan");
        ...
        this.f_19804_.m_135372_(DATA_Tick, (Object)1);
    }
    ...
    public void m_6075_() {
        ...
        IrongolemtitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
