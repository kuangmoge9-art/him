...
public class StarlightskeletonModel
extends GeoModel<StarlightskeletonEntity> {
    public void setCustomAnimations(StarlightskeletonEntity animatable, long instanceId, AnimationState<StarlightskeletonEntity> animationState) {
    ...
    public ResourceLocation getAnimationResource(StarlightskeletonEntity entity) {
        return new ResourceLocation("ultimateskeletons", "animations/starlightskeleton.animation.json");
    }

    public ResourceLocation getModelResource(StarlightskeletonEntity entity) {
        return new ResourceLocation("ultimateskeletons", "geo/starlightskeleton.geo.json");
    }

    public ResourceLocation getTextureResource(StarlightskeletonEntity entity) {
