...
public class HarcadiumgolemtitanModel
extends GeoModel<HarcadiumgolemtitanEntity> {
    public ResourceLocation getAnimationResource(HarcadiumgolemtitanEntity entity) {
        return new ResourceLocation("ultimateskeletons", "animations/irongolemtitan.animation.json");
    }

    public ResourceLocation getModelResource(HarcadiumgolemtitanEntity entity) {
        return new ResourceLocation("ultimateskeletons", "geo/irongolemtitan.geo.json");
    }

    public ResourceLocation getTextureResource(HarcadiumgolemtitanEntity entity) {
