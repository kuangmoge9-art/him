...
public class VoidgolemtitanModel
extends GeoModel<VoidgolemtitanEntity> {
    public ResourceLocation getAnimationResource(VoidgolemtitanEntity entity) {
        return new ResourceLocation("ultimateskeletons", "animations/irongolemtitan.animation.json");
    }

    public ResourceLocation getModelResource(VoidgolemtitanEntity entity) {
        return new ResourceLocation("ultimateskeletons", "geo/irongolemtitan.geo.json");
    }

    public ResourceLocation getTextureResource(VoidgolemtitanEntity entity) {
