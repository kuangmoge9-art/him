...
public class WitherskeletontitanModel
extends GeoModel<WitherskeletontitanEntity> {
    public void setCustomAnimations(WitherskeletontitanEntity animatable, long instanceId, AnimationState<WitherskeletontitanEntity> animationState) {
    ...
    public ResourceLocation getAnimationResource(WitherskeletontitanEntity entity) {
        return new ResourceLocation("ultimateskeletons", "animations/witherskeletontitan.animation.json");
    }

    public ResourceLocation getModelResource(WitherskeletontitanEntity entity) {
        return new ResourceLocation("ultimateskeletons", "geo/witherskeletontitan.geo.json");
    }

    public ResourceLocation getTextureResource(WitherskeletontitanEntity entity) {
