...
import net.mcreator.ultimateskeletons.procedures.EnergyskeletontitanATKProcedure;
...
public class EnergyskeletontitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(EnergyskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public EnergyskeletontitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<EnergyskeletontitanEntity>)((EntityType)UltimateskeletonsModEntities.ENERGYSKELETONTITAN.get()), world);
    }

    public EnergyskeletontitanEntity(EntityType<EnergyskeletontitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(400000.0);
        this.setHEALTS(400000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"wither_skeleton_power");
    ...
    public void m_6075_() {
        ...
        if (this.get_health() < this.getMax_Health()) {
            if (this.get_health() >= 1.0) {
                this.setHEALTS(this.get_health() + 80.0);
            } else {
                this.setHEALTS(0.0);
            }
        }
        if (this.m_21223_() <= 100000.0f) {
        ...
        EnergyskeletontitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
                if (this.getflyID() == 1) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeleton_power.fly"));
                }
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeleton_power.move"));
            }
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeleton_power.general"));
        }
