...
public class BedrockgolemtitanLayer
extends GeoRenderLayer<BedrockgolemtitanEntity> {
    private static final ResourceLocation LAYER = new ResourceLocation("ultimateskeletons", "textures/entities/bedrockgolemtitanglow.png");

    public BedrockgolemtitanLayer(GeoRenderer<BedrockgolemtitanEntity> entityRenderer) {
