...
public class StarlightblackholeLayer
extends GeoRenderLayer<StarlightblackholeEntity> {
    private static final ResourceLocation LAYER = new ResourceLocation("ultimateskeletons", "textures/entities/enchanted.png");

    public StarlightblackholeLayer(GeoRenderer<StarlightblackholeEntity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, StarlightblackholeEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
