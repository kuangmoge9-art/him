...
public class SolarskeletonLayer
extends GeoRenderLayer<SolarskeletonEntity> {
    private static final ResourceLocation LAYER = new ResourceLocation("ultimateskeletons", "textures/entities/solarskeletonglow.png");

    public SolarskeletonLayer(GeoRenderer<SolarskeletonEntity> entityRenderer) {
