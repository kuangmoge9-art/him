...
public class StarskeletonpowertitanLayer
extends GeoRenderLayer<StarskeletonpowertitanEntity> {
    private static final ResourceLocation LAYER = new ResourceLocation("ultimateskeletons", "textures/entities/star_skeleton_powerglow.png");

    public StarskeletonpowertitanLayer(GeoRenderer<StarskeletonpowertitanEntity> entityRenderer) {
