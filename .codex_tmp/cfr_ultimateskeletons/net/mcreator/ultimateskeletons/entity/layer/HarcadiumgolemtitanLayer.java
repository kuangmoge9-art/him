...
public class HarcadiumgolemtitanLayer
extends GeoRenderLayer<HarcadiumgolemtitanEntity> {
    private static final ResourceLocation LAYER = new ResourceLocation("ultimateskeletons", "textures/entities/enchant.png");

    public HarcadiumgolemtitanLayer(GeoRenderer<HarcadiumgolemtitanEntity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, HarcadiumgolemtitanEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
