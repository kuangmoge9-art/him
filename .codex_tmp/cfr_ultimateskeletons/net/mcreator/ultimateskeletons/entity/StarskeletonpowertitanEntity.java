...
import net.mcreator.ultimateskeletons.procedures.StarskeletonpowertitanATKProcedure;
...
public class StarskeletonpowertitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(StarskeletonpowertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public StarskeletonpowertitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<StarskeletonpowertitanEntity>)((EntityType)UltimateskeletonsModEntities.STARSKELETONPOWERTITAN.get()), world);
    }

    public StarskeletonpowertitanEntity(EntityType<StarskeletonpowertitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(600000.0);
        this.setHEALTS(600000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"star_skeleton_power");
    ...
    public void m_6075_() {
        ...
        if (this.get_health() < this.getMax_Health()) {
            if (this.get_health() >= 1.0) {
                this.setHEALTS(this.get_health() + 100.0);
            } else {
                this.setHEALTS(0.0);
            }
        }
        if (this.m_21223_() <= 150000.0f) {
        ...
        this.hasTrail = this.getAnimatedID() > 0 && this.getAnimatedTick() >= 4;
        StarskeletonpowertitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(30.0f);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22284_, 23.5);
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
                if (this.getflyID() == 1) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.starskeletonpower.fly"));
                }
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.starskeletonpower.move"));
            }
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.starskeletonpower.general"));
        }
    ...
    private void lightningAura() {
        ...
        for (int i = 0; i < 1; ++i) {
            ...
            lightning.m_20088_().m_135381_(GhostlightningEntity.size, (Object)Float.valueOf(MathUtils.randFloat(0.04f, 0.6f)));
            ...
            lightning.m_20219_(this.m_20182_().m_82520_(MathUtils.randDouble(-radius, radius), MathUtils.randDouble(-2.0f * radius, 2.0 * (double)radius), MathUtils.randDouble(-radius, radius)).m_82520_(0.0, (double)(this.m_20206_() / 2.0f), 0.0));
