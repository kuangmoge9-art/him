...
import net.mcreator.ultimateskeletons.procedures.SkeletontitanATKProcedure;
...
public class SkeletontitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(SkeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public SkeletontitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<SkeletontitanEntity>)((EntityType)UltimateskeletonsModEntities.SKELETONTITAN.get()), world);
    }

    public SkeletontitanEntity(EntityType<SkeletontitanEntity> type, Level world) {
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"skeleton_titan");
    ...
    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:skeletontitanidle")), 20.0f, 1.0f);
    }
    ...
    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:skeletontitanhurt")), 20.0f, 1.0f);
    }
    ...
    public void m_6075_() {
            ...
            if (this.get_health() >= 1.0) {
                if (this.getkillCount() > 5000) {
                    ...
                    if (this.getAnimatedID() == 4 && this.getAnimatedTick() == 10) {
                        this.setHEALTS(this.get_health() + 400.0);
                    }
                    if (this.getAnimatedID() == 8 && this.getAnimatedTick() >= 66) {
                        this.setHEALTS(this.get_health() + 40.0);
                    }
                    if (this.getAnimatedID() == 6 && this.getAnimatedTick() >= 66) {
                        this.setHEALTS(this.get_health() + 40.0);
                    }
                } else {
        ...
        SkeletontitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public void set_health(double h) {
        ...
        double a = 4000.0f / (float)this.defencecount;
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            if (this.getspawntick() >= 10 && this.m_21223_() <= 0.0f) {
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeletontitan.death"));
            }
            if (this.m_21223_() > 0.0f) {
                if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
                    if (this.getflyID() == 1) {
                        return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeletontitan.fly"));
                    }
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeletontitan.move"));
                }
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.skeletontitan.general"));
            }
        }
