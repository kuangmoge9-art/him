...
import net.mcreator.ultimateskeletons.procedures.AdamantiumgolemtitanATKProcedure;
...
public class AdamantiumgolemtitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(AdamantiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public AdamantiumgolemtitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AdamantiumgolemtitanEntity>)((EntityType)UltimateskeletonsModEntities.ADAMANTIUMGOLEMTITAN.get()), world);
    }

    public AdamantiumgolemtitanEntity(EntityType<AdamantiumgolemtitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(1.0E7);
        this.setHEALTS(1.0E7);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"adamantiumgolemtitan");
    ...
    protected void m_8099_() {
        ...
        this.f_21346_.m_25352_(2, new TitanNearestAttackableTargetGoal<Titangodentity>((Mob)this, Titangodentity.class, 5, false, false, Entity::m_6084_));
        this.f_21346_.m_25352_(3, new TitanNearestAttackableTargetGoal<PathfinderMob>((Mob)this, PathfinderMob.class, 5, false, false, Entity::m_6084_));
    }
    ...
    public boolean m_6469_(DamageSource source, float amount) {
        if (this.getspawntick() > 180) {
            if (amount >= 100000.0f && source.m_276093_(ResourceKey.m_135785_((ResourceKey)Registries.f_268580_, (ResourceLocation)new ResourceLocation("ultimateskeletons:titangoddamage")))) {
                this.set_health(this.get_health() - (double)amount * 0.01);
            }
            if (this.damageInvTime <= 0) {
                if (amount >= 100000.0f && (source.m_7640_() instanceof Titangodentity || source.m_7640_() instanceof Player)) {
                    this.set_health(this.get_health() - (double)amount * 0.01);
                }
                if (amount < 100000.0f && !(source.m_7640_() instanceof Titangodentity) && !(source.m_7640_() instanceof Player) && !source.m_276093_(ResourceKey.m_135785_((ResourceKey)Registries.f_268580_, (ResourceLocation)new ResourceLocation("ultimateskeletons:titangoddamage")))) {
                    return false;
                }
    ...
    public void m_6075_() {
        ...
        AdamantiumgolemtitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        boolean bl = this.hasTrail = this.getAnimatedID() == 7;
        if (this.getAnimatedID() == 9 && this.getAnimatedTick() <= 55 && this.getAnimatedTick() >= 42) {
            float ex = 2.0f * this.m_20205_();
            float fl = this.f_20883_ * ((float)Math.PI / 180);
            float fl1 = Mth.m_14031_((float)fl);
            float fl2 = Mth.m_14089_((float)fl);
            Vec3 leftPos = new Vec3(this.m_20185_() - (double)(fl2 * ex), this.m_20186_() + 0.4 * (double)this.m_20206_(), this.m_20189_() - (double)(fl1 * ex));
            ...
            Vec3 rightPos = new Vec3(this.m_20185_() + (double)(fl2 * ex), this.m_20186_() + 0.4 * (double)this.m_20206_(), this.m_20189_() + (double)(fl1 * ex));
            RedlightningEntity lightningBolt2 = new RedlightningEntity((EntityType<RedlightningEntity>)((EntityType)UltimateskeletonsModEntities.REDLIGHTNING.get()), this.m_9236_());
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22284_, 24.75);
