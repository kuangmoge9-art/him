...
import net.mcreator.ultimateskeletons.procedures.TitanusgolemtitanATKProcedure;
...
public class TitanusgolemtitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(TitanusgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public TitanusgolemtitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<TitanusgolemtitanEntity>)((EntityType)UltimateskeletonsModEntities.TITANUSGOLEMTITAN.get()), world);
    }

    public TitanusgolemtitanEntity(EntityType<TitanusgolemtitanEntity> type, Level world) {
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"titanus_golem_titan");
    ...
    public float getCurrentRadius() {
        return Math.max(this.currentRadius, 0.0f);
    }
    ...
    public void m_6075_() {
        ...
        if (this.get_health() < this.getMax_Health()) {
            if (this.getAnimatedID() == 4 && this.getAnimatedTick() == 14) {
                this.setHEALTS(this.get_health() + 20000.0);
            }
            if (this.getAnimatedID() == 5 && this.getAnimatedTick() == 40) {
                this.setHEALTS(this.get_health() + 40000.0);
            }
            if (this.getAnimatedID() == 6 && this.getAnimatedTick() >= 35) {
                this.setHEALTS(this.get_health() + 1200.0);
            }
            if (this.get_health() >= 1.0) {
                this.setHEALTS(this.get_health() + 10.0);
            } else {
                this.setHEALTS(0.0);
            }
        }
        ...
        if (this.getAnimatedID() == 6) {
            if (this.getAnimatedTick() >= 20 && this.getAnimatedTick() <= 33) {
                this.currentRadius = this.getAnimatedTick() <= 30 ? (this.currentRadius += growthRate) : (this.currentRadius -= growthRate);
            }
            if (this.getAnimatedTick() < 20) {
                this.currentRadius = 0.0f;
            }
        }
        if (this.getAnimatedID() == 6 && this.getAnimatedTick() >= 128) {
            this.currentRadius -= growthRate;
        }
        TitanusgolemtitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
