...
public class StarshockEntity
extends Titangodentity {
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(StarshockEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public StarshockEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<StarshockEntity>)((EntityType)UltimateskeletonsModEntities.STARSHOCK.get()), world);
    }

    public StarshockEntity(EntityType<StarshockEntity> type, Level world) {
