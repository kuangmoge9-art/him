...
import net.mcreator.ultimateskeletons.procedures.StarspawngalaxyDangShiTiGengXinKeShiProcedure;
...
public class StarspawngalaxyEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(StarspawngalaxyEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(StarspawngalaxyEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(StarspawngalaxyEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(StarspawngalaxyEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public StarspawngalaxyEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<StarspawngalaxyEntity>)((EntityType)UltimateskeletonsModEntities.STARSPAWNGALAXY.get()), world);
    }

    public StarspawngalaxyEntity(EntityType<StarspawngalaxyEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"galaxy");
    ...
    public void m_6075_() {
        super.m_6075_();
        StarspawngalaxyDangShiTiGengXinKeShiProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
