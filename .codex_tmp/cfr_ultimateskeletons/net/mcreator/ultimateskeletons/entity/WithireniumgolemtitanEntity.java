...
import net.mcreator.ultimateskeletons.procedures.WithireniumgolemtitanATKProcedure;
...
public class WithireniumgolemtitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(WithireniumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public WithireniumgolemtitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<WithireniumgolemtitanEntity>)((EntityType)UltimateskeletonsModEntities.WITHIRENIUMGOLEMTITAN.get()), world);
    }

    public WithireniumgolemtitanEntity(EntityType<WithireniumgolemtitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(2000000.0);
        this.setHEALTS(2000000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"withireniumgolemtitan");
    ...
    public void m_6075_() {
        ...
        WithireniumgolemtitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        if (this.getAnimatedID() == 6 && this.getAnimatedTick() == 22) {
            float ex = 1.2f * this.m_20205_();
            ...
            this.m_9236_().m_7106_((ParticleOptions)UltimateskeletonsModParticleTypes.MULTIVERSEWAVE.get(), this.m_20185_() - (double)(fl2 * ex) + this.m_20154_().f_82479_ * 9.0, this.m_20186_() + (double)0.1f, this.m_20189_() - (double)(fl1 * ex) + this.m_20154_().f_82481_ * 9.0, 0.0, 0.0, 0.0);
