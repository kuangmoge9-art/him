...
import net.mcreator.ultimateskeletons.procedures.MultiversespaceATKProcedure;
...
public class MultiversespaceEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(MultiversespaceEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(MultiversespaceEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(MultiversespaceEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_gamaTick = SynchedEntityData.m_135353_(MultiversespaceEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_gamaspawnTick = SynchedEntityData.m_135353_(MultiversespaceEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public MultiversespaceEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<MultiversespaceEntity>)((EntityType)UltimateskeletonsModEntities.MULTIVERSESPACE.get()), world);
    }

    public MultiversespaceEntity(EntityType<MultiversespaceEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    public void m_6075_() {
        super.m_6075_();
        MultiversespaceATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }

    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(80.0f);
    }
