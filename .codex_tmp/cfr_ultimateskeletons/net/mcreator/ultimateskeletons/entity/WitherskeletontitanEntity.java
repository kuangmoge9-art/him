...
import net.mcreator.ultimateskeletons.procedures.WitherskeletontitanATKProcedure;
...
public class WitherskeletontitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(WitherskeletontitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public WitherskeletontitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<WitherskeletontitanEntity>)((EntityType)UltimateskeletonsModEntities.WITHERSKELETONTITAN.get()), world);
    }

    public WitherskeletontitanEntity(EntityType<WitherskeletontitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 50000;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(200000.0);
        this.setHEALTS(200000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"wither_skeleton_titan");
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:witherskeletontitanidle"));
    }

    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:witherskeletontitanidle")), 20.0f, 1.0f);
    }
    ...
    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:witherskeletontitanhurt")), 20.0f, 1.0f);
    }

    public SoundEvent m_7975_(DamageSource ds) {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:witherskeletontitanhurt"));
    }

    public SoundEvent m_5592_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:witherskeletontitandeath"));
    }

    @Override
    public boolean m_6469_(DamageSource source, float amount) {
        if (this.getspawntick() > 510) {
            if (this.getkillCount() <= 10000) {
            ...
            } else if (this.damageInvTime <= 0 && source.m_276093_(ResourceKey.m_135785_((ResourceKey)Registries.f_268580_, (ResourceLocation)new ResourceLocation("ultimateskeletons:titangoddamage")))) {
                this.set_health(this.get_health() - (double)amount * 0.06);
                this.damageInvTime = 10 * this.defencecount;
            }
    ...
    public void m_6075_() {
        ...
        if (this.get_health() < this.getMax_Health()) {
            if (this.get_health() >= 1.0) {
                if (this.getkillCount() > 10000) {
                    this.setHEALTS(this.get_health() + 60.0);
                    if (this.getAnimatedID() == 4 && this.getAnimatedTick() == 10) {
                        this.setHEALTS(this.get_health() + 2000.0);
                    }
                    if (this.getAnimatedID() == 5 && this.getAnimatedTick() == 34) {
                        this.setHEALTS(this.get_health() + 10000.0);
                    }
                } else {
                    this.setHEALTS(this.get_health() + 40.0);
                }
            } else {
                this.setHEALTS(0.0);
            }
        ...
        if (this.getkillCount() > 10000) {
            this.defencecount = 2;
            this.hasTrail = this.getAnimatedID() > 0;
        } else {
            this.hasTrail = false;
        }
        if (this.getkillCount() > 10000) {
            this.energy = this.m_21223_() > 0.0f;
        } else if (this.m_21223_() <= 50000.0f) {
        ...
        WitherskeletontitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public void set_health(double h) {
        ...
        double a = 20000.0f / (float)this.defencecount;
    ...
    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(28.0f);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22284_, 23.0);
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            if (this.getspawntick() >= 10 && this.m_21223_() <= 0.0f) {
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.witherskeletontitan.death"));
            }
            if (this.m_21223_() > 0.0f) {
                if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
                    if (this.getflyID() == 1) {
                        return event.setAndContinue(RawAnimation.begin().thenLoop("animation.witherskeletontitan.fly"));
                    }
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.witherskeletontitan.move"));
                }
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.witherskeletontitan.general"));
            }
        }
