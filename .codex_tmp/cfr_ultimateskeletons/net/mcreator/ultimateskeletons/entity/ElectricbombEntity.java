...
import net.mcreator.ultimateskeletons.procedures.ElectricbombATKProcedure;
...
public class ElectricbombEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(ElectricbombEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(ElectricbombEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(ElectricbombEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_gamaTick = SynchedEntityData.m_135353_(ElectricbombEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_gamaspawnTick = SynchedEntityData.m_135353_(ElectricbombEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_groundTick = SynchedEntityData.m_135353_(ElectricbombEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public ElectricbombEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<ElectricbombEntity>)((EntityType)UltimateskeletonsModEntities.ELECTRICBOMB.get()), world);
    }

    public ElectricbombEntity(EntityType<ElectricbombEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(DATA_groundTick, (Object)0);
    }
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128405_("DatagroundTick", ((Integer)this.f_19804_.m_135370_(DATA_groundTick)).intValue());
    }
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("DatagroundTick")) {
            this.f_19804_.m_135381_(DATA_groundTick, (Object)compound.m_128451_("DatagroundTick"));
        }
    }

    public void m_6075_() {
        super.m_6075_();
        ElectricbombATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
