...
import net.mcreator.ultimateskeletons.procedures.HararrowatkProcedure;
...
public class HarrowEntity
extends AbstractArrow
implements ItemSupplier {
    public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)UltimateskeletonsModItems.CLEAR.get());

    public HarrowEntity(PlayMessages.SpawnEntity packet, Level world) {
        super((EntityType)UltimateskeletonsModEntities.HARROW.get(), world);
    }

    public HarrowEntity(EntityType<? extends HarrowEntity> type, Level world) {
        super(type, world);
    }

    public HarrowEntity(EntityType<? extends HarrowEntity> type, double x, double y, double z, Level world) {
        super(type, x, y, z, world);
    }

    public HarrowEntity(EntityType<? extends HarrowEntity> type, LivingEntity entity, Level world) {
    ...
    public void m_8119_() {
        super.m_8119_();
        HararrowatkProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this.m_19749_());
        if (this.f_36703_) {
            this.m_146870_();
        }
    }

    public static HarrowEntity shoot(Level world, LivingEntity entity, RandomSource source) {
        return HarrowEntity.shoot(world, entity, source, 1.0f, 5.0, 5);
    }

    public static HarrowEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
        HarrowEntity entityarrow = new HarrowEntity((EntityType<? extends HarrowEntity>)((EntityType)UltimateskeletonsModEntities.HARROW.get()), entity, world);
    ...
    public static HarrowEntity shoot(LivingEntity entity, LivingEntity target) {
        HarrowEntity entityarrow = new HarrowEntity((EntityType<? extends HarrowEntity>)((EntityType)UltimateskeletonsModEntities.HARROW.get()), entity, entity.m_9236_());
