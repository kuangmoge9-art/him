...
import net.mcreator.ultimateskeletons.procedures.WitherskeletontemplaratkProcedure;
...
public class WitherskeletontemplarEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnID = SynchedEntityData.m_135353_(WitherskeletontemplarEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public WitherskeletontemplarEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<WitherskeletontemplarEntity>)((EntityType)UltimateskeletonsModEntities.WITHERSKELETONTEMPLAR.get()), world);
    }
    ...
    public void m_21153_(float heal) {
        ...
        if (heal > healthremain) {
            healthremain = heal;
        } else if (this.m_9236_().m_46467_() % 8L == 0L) {
    ...
    public WitherskeletontemplarEntity(EntityType<WitherskeletontemplarEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"wither_skeleton_templar");
        ...
        this.f_19804_.m_135372_(DATA_spawnID, (Object)0);
    }
    ...
    public boolean m_6469_(DamageSource source, float amount) {
        WitherskeletontemplarEntity entity = this;
        Level world = entity.m_9236_();
        double x = entity.m_20185_();
        double y = entity.m_20186_();
        double z = entity.m_20189_();
        Vec3 center = new Vec3(x, y, z);
        if ((amount = (float)((double)amount / (this.m_21051_(Attributes.f_22284_).m_22135_() / 4.0))) >= 50.0f) {
            amount = 50.0f;
        }
        if (!this.m_20159_()) {
            if (source.m_7640_() != null) {
                Entity entityiterator = source.m_7640_();
                if (Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)10) == 5 && entityiterator == source.m_7640_()) {
                    entity.m_20256_(new Vec3((entity.m_20185_() - entityiterator.m_20185_()) / (double)entity.m_20270_(entityiterator) * 2.0, entity.m_20184_().f_82480_, (entity.m_20189_() - entityiterator.m_20189_()) / (double)entity.m_20270_(entityiterator) * 2.0));
                    return false;
                }
                if (this.getAnimatedID() == 0 && this.m_5448_() != null) {
                    this.setAnimatedTick(0);
                    this.setAnimatedID(6);
                    this.setAnimatedTick(0);
                    return false;
                }
                if (this.getAnimatedID() == 0 && Mth.m_216271_((RandomSource)RandomSource.m_216327_(), (int)1, (int)10) == 5) {
                    this.setAnimatedTick(0);
                    this.setAnimatedID(6);
                    this.setAnimatedTick(0);
                    return false;
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128405_("DataspawnID", ((Integer)this.f_19804_.m_135370_(DATA_spawnID)).intValue());
    }
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("DataspawnID")) {
            this.f_19804_.m_135381_(DATA_spawnID, (Object)compound.m_128451_("DataspawnID"));
        }
    }
    ...
    public void m_6075_() {
        ...
        super.m_6075_();
        WitherskeletontemplaratkProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
        ...
        if (this.animationprocedure.equals("empty")) {
            if (this.m_21223_() >= 1.0f) {
                if (this.getAnimatedID() == 1) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.atk"));
                }
                if (this.getAnimatedID() == 2) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.slash"));
                }
                if (this.getAnimatedID() == 3) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.cut"));
                }
                if (this.getAnimatedID() == 4) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.summon"));
                }
                if (this.getAnimatedID() == 6) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.defence"));
                }
                ...
                return event.setAndContinue(RawAnimation.begin().thenPlay("animation.idle"));
            }
        }
