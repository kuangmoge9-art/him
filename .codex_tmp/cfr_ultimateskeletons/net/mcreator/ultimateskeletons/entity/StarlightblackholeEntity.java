...
public class StarlightblackholeEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(StarlightblackholeEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(StarlightblackholeEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(StarlightblackholeEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(StarlightblackholeEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public StarlightblackholeEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<StarlightblackholeEntity>)((EntityType)UltimateskeletonsModEntities.STARLIGHTBLACKHOLE.get()), world);
    }

    public StarlightblackholeEntity(EntityType<StarlightblackholeEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.earth"));
        }
