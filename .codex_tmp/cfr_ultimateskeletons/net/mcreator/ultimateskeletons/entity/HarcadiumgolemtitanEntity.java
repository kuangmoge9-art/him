...
import net.mcreator.ultimateskeletons.procedures.HarcadiumgolemtitanATKProcedure;
...
public class HarcadiumgolemtitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(HarcadiumgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public HarcadiumgolemtitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<HarcadiumgolemtitanEntity>)((EntityType)UltimateskeletonsModEntities.HARCADIUMGOLEMTITAN.get()), world);
    }

    public HarcadiumgolemtitanEntity(EntityType<HarcadiumgolemtitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(1500000.0);
        this.setHEALTS(1500000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"harcadiumgolemtitan");
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:void"));
    }
    ...
    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:void")), 100.0f, 1.0f);
    }
    ...
    public void m_6075_() {
        ...
        HarcadiumgolemtitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
