...
import net.mcreator.ultimateskeletons.procedures.GhasttitanATKProcedure;
...
public class GhasttitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Boolean> DATA_fire = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<Integer> DATA_killCount = SynchedEntityData.m_135353_(GhasttitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public GhasttitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<GhasttitanEntity>)((EntityType)UltimateskeletonsModEntities.GHASTTITAN.get()), world);
    }

    public GhasttitanEntity(EntityType<GhasttitanEntity> type, Level world) {
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"ghast_titan");
        ...
        this.f_19804_.m_135372_(DATA_fire, (Object)false);
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:ghasttitanidle"));
    }

    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:ghasttitanidle")), 40.0f, 1.0f);
    }

    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:ghasttitanhurt")), 40.0f, 1.0f);
    }

    public SoundEvent m_7975_(DamageSource ds) {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:ghasttitanhurt"));
    }

    public SoundEvent m_5592_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:ghasttitandeath"));
    }
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128379_("Datafire", ((Boolean)this.f_19804_.m_135370_(DATA_fire)).booleanValue());
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("Datafire")) {
            this.f_19804_.m_135381_(DATA_fire, (Object)compound.m_128471_("Datafire"));
        }
    ...
    public void m_6075_() {
        ...
        GhasttitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(60.0f);
    }
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.ghast_titan.move"));
        }
