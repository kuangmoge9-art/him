...
import net.mcreator.ultimateskeletons.procedures.DeathwitherbeamATKProcedure;
...
public class DeathwitherbeamEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(DeathwitherbeamEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(DeathwitherbeamEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(DeathwitherbeamEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_gamaTick = SynchedEntityData.m_135353_(DeathwitherbeamEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_gamaspawnTick = SynchedEntityData.m_135353_(DeathwitherbeamEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public DeathwitherbeamEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<DeathwitherbeamEntity>)((EntityType)UltimateskeletonsModEntities.DEATHWITHERBEAM.get()), world);
    }

    public DeathwitherbeamEntity(EntityType<DeathwitherbeamEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    public void m_6075_() {
        super.m_6075_();
        DeathwitherbeamATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
