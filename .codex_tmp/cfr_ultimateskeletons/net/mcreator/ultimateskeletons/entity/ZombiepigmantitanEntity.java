...
import net.mcreator.ultimateskeletons.procedures.PigzombietitanATKProcedure;
...
public class ZombiepigmantitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_killCount = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(ZombiepigmantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public ZombiepigmantitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<ZombiepigmantitanEntity>)((EntityType)UltimateskeletonsModEntities.ZOMBIEPIGMANTITAN.get()), world);
    }

    public ZombiepigmantitanEntity(EntityType<ZombiepigmantitanEntity> type, Level world) {
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"zombie_pigman_titan");
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:pigzombietitanidle"));
    }

    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:pigzombietitanidle")), 20.0f, 1.0f);
    }
    ...
    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:pigzombietitanhurt")), 20.0f, 1.0f);
    }

    public SoundEvent m_7975_(DamageSource ds) {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:pigzombietitanhurt"));
    }

    public SoundEvent m_5592_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:pigzombietitandeath"));
    }

    @Override
    public boolean m_6469_(DamageSource source, float amount) {
        if (this.getspawntick() > 450) {
    ...
    @Override
    public void m_6075_() {
        RedlightningEntity lightningBolt1;
        Vec3 leftPos;
        float fl2;
        float fl1;
        float fl;
        ...
        if (this.get_health() < this.getMax_Health()) {
            if (this.get_health() >= 1.0) {
                this.set_health(this.get_health() + 20.0);
            } else {
                this.set_health(0.0);
            }
        }
        ...
        PigzombietitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        if (this.getAnimatedID() == 10) {
            boolean bl = this.lightning = this.getAnimatedTick() >= 39 && this.getAnimatedTick() <= 61;
            if (this.getAnimatedTick() <= 90 && this.getAnimatedTick() >= 75) {
                ex = 0.6f * this.m_20205_();
                fl = this.f_20883_ * ((float)Math.PI / 180);
                fl1 = Mth.m_14031_((float)fl);
                fl2 = Mth.m_14089_((float)fl);
                leftPos = new Vec3(this.m_20185_() + (double)(fl2 * ex), this.m_20186_() + 1.1 * (double)this.m_20206_(), this.m_20189_() + (double)(fl1 * ex));
                lightningBolt1 = new RedlightningEntity((EntityType<RedlightningEntity>)((EntityType)UltimateskeletonsModEntities.REDLIGHTNING.get()), this.m_9236_());
        ...
        if (this.getAnimatedID() == 6 && this.getAnimatedTick() <= 80 && this.getAnimatedTick() >= 40) {
            ...
            fl1 = Mth.m_14031_((float)fl);
            fl2 = Mth.m_14089_((float)fl);
            leftPos = new Vec3(this.m_20185_() - (double)(fl2 * ex), this.m_20186_() + 0.96 * (double)this.m_20206_(), this.m_20189_() - (double)(fl1 * ex));
            lightningBolt1 = new RedlightningEntity((EntityType<RedlightningEntity>)((EntityType)UltimateskeletonsModEntities.REDLIGHTNING.get()), this.m_9236_());
            lightningBolt1.m_20219_(leftPos);
            this.m_9236_().m_7967_((Entity)lightningBolt1);
            Vec3 rightPos = new Vec3(this.m_20185_() + (double)(fl2 * ex), this.m_20186_() + 0.96 * (double)this.m_20206_(), this.m_20189_() + (double)(fl1 * ex));
            GamalightningEntity lightningBolt2 = new GamalightningEntity((EntityType<GamalightningEntity>)((EntityType)UltimateskeletonsModEntities.GAMALIGHTNING.get()), this.m_9236_());
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            ...
            return event.setAndContinue(RawAnimation.begin().thenLoop("general"));
        }
