...
import net.mcreator.ultimateskeletons.procedures.EndermantitanATKProcedure;
...
public class EndermantitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animatonID = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_killCount = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_roarTick = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(EndermantitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public EndermantitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<EndermantitanEntity>)((EntityType)UltimateskeletonsModEntities.ENDERMANTITAN.get()), world);
    }

    public EndermantitanEntity(EntityType<EndermantitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 100000;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(300000.0);
        this.setHEALTS(300000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"ender_colossus");
        this.f_19804_.m_135372_(DATA_animatonID, (Object)0);
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128405_("DataanimatonID", ((Integer)this.f_19804_.m_135370_(DATA_animatonID)).intValue());
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("DataanimatonID")) {
            this.f_19804_.m_135381_(DATA_animatonID, (Object)compound.m_128451_("DataanimatonID"));
        }
    ...
    public void m_6075_() {
        ...
        EndermantitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(23.0f);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22281_, 1000.0);
