...
import net.mcreator.ultimateskeletons.procedures.BlackholeATKProcedure;
...
extends Titangodentity {
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(BlackholeEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    private float currentRadius = 0.0f;
    private float maxRadius = 10.0f;
    private float growthRate = 0.16f;

    public BlackholeEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<BlackholeEntity>)((EntityType)UltimateskeletonsModEntities.BLACKHOLE.get()), world);
    }
    ...
    public void m_6075_() {
        ...
        if (this.getTick() >= 160) {
            RenderUtils.explosionVfx(200.0f, 30, this.m_20182_(), new Vec3(225.0, 100.0, 255.0), this.m_9236_(), false);
            this.setHEALTS(0.0);
            this.m_142467_(Entity.RemovalReason.DISCARDED);
        }
        BlackholeATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
    }
