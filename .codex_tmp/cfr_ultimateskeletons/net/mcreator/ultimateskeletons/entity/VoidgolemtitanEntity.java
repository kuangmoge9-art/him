...
import net.mcreator.ultimateskeletons.procedures.VoidgolemtitanATKProcedure;
...
public class VoidgolemtitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(VoidgolemtitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public VoidgolemtitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<VoidgolemtitanEntity>)((EntityType)UltimateskeletonsModEntities.VOIDGOLEMTITAN.get()), world);
    }

    public VoidgolemtitanEntity(EntityType<VoidgolemtitanEntity> type, Level world) {
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"void_golem_titan");
        ...
        this.f_19804_.m_135372_(DATA_Tick, (Object)50);
    }
    ...
    public boolean m_6469_(DamageSource source, float amount) {
        if (source.m_276093_(ResourceKey.m_135785_((ResourceKey)Registries.f_268580_, (ResourceLocation)new ResourceLocation("ultimateskeletons:titangoddamage")))) {
            this.set_health(this.get_health() - (double)amount * 0.03);
        }
    ...
    public void m_6075_() {
        ...
        VoidgolemtitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        if (this.getAnimatedID() == 6 && this.getAnimatedTick() == 40) {
            RenderUtils.explosionVfx(200.0f, 60, new Vec3(this.m_20185_(), this.m_20186_() + 90.0, this.m_20189_()), new Vec3(225.0, 100.0, 255.0), this.m_9236_(), false);
        }
        this.m_6210_();
    }
    ...
    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(27.0f);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22284_, 24.25);
