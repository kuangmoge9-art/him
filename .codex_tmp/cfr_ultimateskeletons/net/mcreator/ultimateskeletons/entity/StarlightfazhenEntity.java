...
import net.mcreator.ultimateskeletons.procedures.StarlightspawnProcedure;
...
public class StarlightfazhenEntity
extends PathfinderMob
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(StarlightfazhenEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(StarlightfazhenEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(StarlightfazhenEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(StarlightfazhenEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public StarlightfazhenEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<StarlightfazhenEntity>)((EntityType)UltimateskeletonsModEntities.STARLIGHTFAZHEN.get()), world);
    }

    public StarlightfazhenEntity(EntityType<StarlightfazhenEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    public void m_21153_(float heal) {
        float healthafter = this.m_21223_() - 1.0f;
    ...
    public void m_6075_() {
        super.m_6075_();
        StarlightspawnProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22277_, 160.0);
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.starspawngalaxy2"));
        }
