...
public class AdminiumshockEntity
extends Titangodentity {
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(AdminiumshockEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public AdminiumshockEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<AdminiumshockEntity>)((EntityType)UltimateskeletonsModEntities.ADMINIUMSHOCK.get()), world);
    }

    public AdminiumshockEntity(EntityType<AdminiumshockEntity> type, Level world) {
