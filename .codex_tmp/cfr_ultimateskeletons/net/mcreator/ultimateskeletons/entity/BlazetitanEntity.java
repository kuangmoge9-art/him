...
import net.mcreator.ultimateskeletons.procedures.BlazetitanATKProcedure;
...
public class BlazetitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_killCount = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(BlazetitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public BlazetitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<BlazetitanEntity>)((EntityType)UltimateskeletonsModEntities.BLAZETITAN.get()), world);
    }

    public BlazetitanEntity(EntityType<BlazetitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(40000.0);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"blaze_titan");
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:blazetitanidle"));
    }

    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:blazetitanidle")), 20.0f, 1.0f);
    }

    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:blazetitanhurt")), 20.0f, 1.0f);
    }

    public SoundEvent m_7975_(DamageSource ds) {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:blazetitanhurt"));
    }

    public SoundEvent m_5592_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:blazetitandeath"));
    }
    ...
    public void m_6075_() {
        super.m_6075_();
        boolean bl = this.target = this.m_5448_() != null;
        ...
        BlazetitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.blazetitan.move"));
        }
        if (this.m_21224_()) {
            return event.setAndContinue(RawAnimation.begin().thenPlay("animation.blazetitan.death"));
        }
        return event.setAndContinue(RawAnimation.begin().thenLoop("animation.blazetitan.move"));
    }
    ...
    private PlayState attackingPredicate(AnimationState event) {
        if (this.getAnimatedID() != 0) {
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.blazetitan.target"));
        }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar data) {
        ...
        data.add(new AnimationController[]{new AnimationController((GeoAnimatable)this, "attacking", 8, this::attackingPredicate)});
