...
import net.mcreator.ultimateskeletons.procedures.CavespidertitanATKProcedure;
...
public class CavespidertitanEntity
extends Titangodentity
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<Integer> DATA_spawnTick = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_deathTick = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationID = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_animationTick = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_killCount = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_Tick = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_flyID = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    public static final EntityDataAccessor<Integer> DATA_webTick = SynchedEntityData.m_135353_(CavespidertitanEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135028_);
    ...
    public CavespidertitanEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<CavespidertitanEntity>)((EntityType)UltimateskeletonsModEntities.CAVESPIDERTITAN.get()), world);
    }

    public CavespidertitanEntity(EntityType<CavespidertitanEntity> type, Level world) {
        super((EntityType<? extends AnimatedEntity>)type, world);
        this.f_21364_ = 0;
        this.m_21557_(false);
        this.m_274367_(1.2f);
        this.setMax_Health(12000.0);
        this.set_health(12000.0);
        this.m_21530_();
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"cave_spider_titan");
        ...
        this.f_19804_.m_135372_(DATA_webTick, (Object)0);
    }
    ...
    public SoundEvent m_7515_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:spidertitanidle"));
    }

    public void m_8032_() {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:spidertitanidle")), 20.0f, 1.0f);
    }
    ...
    public void m_6677_(DamageSource p_21160_) {
        this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:spidertitanhurt")), 20.0f, 1.0f);
    }

    public SoundEvent m_7975_(DamageSource ds) {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:spidertitanhurt"));
    }

    public SoundEvent m_5592_() {
        return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ultimateskeletons:spidertitandeath"));
    }

    @Override
    public boolean m_6469_(DamageSource source, float amount) {
        if (this.getspawntick() > 220) {
    ...
    public void m_7380_(CompoundTag compound) {
        ...
        compound.m_128405_("DatawebTick", ((Integer)this.f_19804_.m_135370_(DATA_webTick)).intValue());
    }
    ...
    public void m_7378_(CompoundTag compound) {
        ...
        if (compound.m_128441_("DatawebTick")) {
            this.f_19804_.m_135381_(DATA_webTick, (Object)compound.m_128451_("DatawebTick"));
        }
    }
    ...
    public void m_6075_() {
        ...
        CavespidertitanATKProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), (Entity)this);
        this.m_6210_();
    }
    ...
    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(12.0f);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.m_22268_(Attributes.f_22281_, 75.0);
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
                if (this.getflyID() == 1) {
                    return event.setAndContinue(RawAnimation.begin().thenLoop("animation.spider.titan.fly"));
                }
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.spider.titan.move"));
            }
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.spider.titan.general"));
        }
